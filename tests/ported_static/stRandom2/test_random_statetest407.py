...
def test_random_statetest407(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x6D71656F054471181163037902615B55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "7f000000000000000000000000ffffffffffffffffffffffffffffffffffffffff437fff"  # noqa: E501
            ...
            "4f3f701464972e74606d6ea82d4d3080599a0e796f6d71656f054471181163037902615b"  # noqa: E501
        ),
        gas_limit=100000,
        value=825575416,
    )
    ...
    post = {
        contract: Account(storage={0: 0x6D71656F054471181163037902615B55}),
    }
