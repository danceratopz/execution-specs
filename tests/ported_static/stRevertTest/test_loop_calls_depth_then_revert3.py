...
def test_loop_calls_depth_then_revert3(
    ...
    contract_0 = Address(0x75290EB6143F33F55A95BC97FCECCA40ECDDB0D9)
    ...
    contract_0 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.POP(
            Op.CALL(
                gas=Op.GAS,
                address=0x75290EB6143F33F55A95BC97FCECCA40ECDDB0D9,
                value=0x0,
                args_offset=0x0,
                args_size=0x0,
                ret_offset=0x0,
        ...
        balance=10,
        nonce=0,
        address=Address(0x75290EB6143F33F55A95BC97FCECCA40ECDDB0D9),  # noqa: E501
    )
