...
Ported from:
tests/static/state_tests/stCallCreateCallCodeTest/callOutput1Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCreateCallCodeTest/callOutput1Filler.json",  # noqa: E501
    ],
)
...
def test_call_output1(
    ...
    # Source: LLL
    # { (MSTORE 0 0x5e20a0453cecd065ea59c37ac63e079ee08998b6045136a8ce6635c7912ec0b6) (CALL 150000 <contract:0xaaae7baea6a6c7c4c2dfeb977efac326af552d87> 0 0 0 0 0) [[ 0 ]] (MLOAD 0) }  # noqa: E501
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x62c381fd04b6e4f31ba6d6f58c6a0d34eee4fc52"),  # noqa: E501
    )
    # Source: raw bytecode
