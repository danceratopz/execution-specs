...
Ported from:
tests/static/state_tests/stRandom/randomStatetest164Filler.json
"""
...
def test_random_statetest164(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffffffffffffffffe417f00000000000000"  # noqa: E501
            ...
            "0000000000000000000000000000000083130539"
        ),
        gas_limit=100000,
        value=1836140782,
    )
