...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest433Filler.json
"""
...
def test_random_statetest433(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "00000000000000000000c350a3f305205bf156207259573055"
        ),
        nonce=0,
        address=Address("0x76ad89792a42a92b922c9be589a0c02b14e7e928"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "701464972e74606d6ea82d4d3080599a0e797f0000000000000000000000000000000000"  # noqa: E501
            "00000000000000000000000000c3507f0000000000000000000000000000000000000000"  # noqa: E501
            "00000000000000000000c350a3f305205bf1562072595730"
        ),
        gas_limit=500000,
        value=630948579,
    )
