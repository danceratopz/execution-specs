...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest571Filler.json
"""
...
def test_random_statetest571(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xc983bd5257b89d1c32d59e0251c5456bc7397124"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000000000000000000000015b7f00000000000000000000"  # noqa: E501
            "000100000000000000000000000000000000000000007f00000000000000000000000000"  # noqa: E501
            "000000000000000000000000000000000000017f0000000000000000000000004f3f7014"  # noqa: E501
            "64972e74606d6ea82d4d3080599a0e793c6508766c8b6b403a"
        ),
        gas_limit=100000,
        value=1402161028,
    )
