...
Ported from:
tests/static/state_tests/stRandom/randomStatetest29Filler.json
"""
...
def test_random_statetest29(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xf5781cfae8099794b4983a68afef46bfce6ab51c"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00ffffffffffffffffffffffffffffffffffffffff087fffffffffffffffffffffffffff"  # noqa: E501
