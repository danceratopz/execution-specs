...
Ported from:
tests/static/state_tests/stRandom/randomStatetest222Filler.json
"""
...
def test_random_statetest222(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x941ec79f0a2a731e1851dc4d0d6d60de70eba4fb"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000001000000000000000000000000000000000000000043397f000000000000"  # noqa: E501
            ...
            "000000000000000000000000000000000000c35081"
        ),
        gas_limit=100000,
        value=1727622047,
    )
