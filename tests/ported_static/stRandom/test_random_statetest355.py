...
Ported from:
tests/static/state_tests/stRandom/randomStatetest355Filler.json
"""
...
def test_random_statetest355(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "004f3f701464972e74606d6ea82d4d3080599a0e79457f00000000000000000000000000"  # noqa: E501
            "0000000000000000000000000000000000c3507f00000000000000000000000000000000"  # noqa: E501
            "00000000000000000000000000000001666b56e87c5a499d5389306e55"
        ),
        nonce=0,
        address=Address("0xcecd2ae07d64d406743f25363af5c2cd6e8ffc2a"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "004f3f701464972e74606d6ea82d4d3080599a0e79457f00000000000000000000000000"  # noqa: E501
            "0000000000000000000000000000000000c3507f00000000000000000000000000000000"  # noqa: E501
            "00000000000000000000000000000001666b56e87c5a499d5389306e"
        ),
        gas_limit=100000,
        value=659556805,
    )
