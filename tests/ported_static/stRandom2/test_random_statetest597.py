...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest597Filler.json
"""
...
def test_random_statetest597(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "000000000000000000004f3f701464972e74606d6ea82d4d3080599a0e79967f00000000"  # noqa: E501
            ...
            "ffffffffffffffffffffffffffffffff3a7e737d40070a156482930a0875"
        ),
        nonce=0,
        address=Address("0x2f021da657fb4d77fbcc8556101f287ddc7e44db"),  # noqa: E501
    )
    # Source: raw bytecode
    pre.deploy_contract(
        code=(
