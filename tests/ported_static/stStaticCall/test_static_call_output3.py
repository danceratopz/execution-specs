"""
Test_static_call_output3.

Ported from:
state_tests/stStaticCall/static_callOutput3Filler.json
"""
...
def test_static_call_output3(
    ...
    addr = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0xBFF7A0D7C11C8F309B6B1E1D6117A2C32B08EE48),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address(0x365AE6E06F46749490DD1D66009D9859DD778823),  # noqa: E501
    )
