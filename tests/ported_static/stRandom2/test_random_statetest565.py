...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest565Filler.json
"""
...
def test_random_statetest565(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000000000c350137f00000000000000"  # noqa: E501
            "0000000000000000000000000000000000000000000000c3507f00000000000000000000"  # noqa: E501
            "000000000000000000000000000000000000000000007f00000000000000000000000100"  # noqa: E501
            "000000000000000000000000000000000000009237"
        ),
        gas_limit=100000,
        value=684525926,
    )
