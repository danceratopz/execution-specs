...
def test_suicide_caller_addres_too_big_left(
    ...
    contract_0 = Address(0xFAE6B99CF03938A3FB097E8E92431B3C1371558B)
    sender = EOA(
    ...
    contract_0 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0xFAE6B99CF03938A3FB097E8E92431B3C1371558B),  # noqa: E501
    )
    ...
    post = {
        ...
        contract_0: Account(storage={0: sender}, balance=0, nonce=0),
    }
