...
Ported from:
tests/static/state_tests/stRandom/randomStatetest293Filler.json
"""
...
def test_random_statetest293(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe417f00000000"  # noqa: E501
            "000000000000000000000000000000000000000000000000000000007fffffffffffffff"  # noqa: E501
            "fffffffffffffffffffffffffffffffffffffffffffffffffe6f45896269948983746009"  # noqa: E501
            "0897f305668284"
        ),
        gas_limit=100000,
        value=1022808999,
