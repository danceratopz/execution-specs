...
Ported from:
tests/static/state_tests/stRandom/randomStatetest327Filler.json
"""
...
def test_random_statetest327(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "00000000000000000000000000000001458b5554397513"
        ),
        nonce=0,
        address=Address("0x85f19e026a6f76db9583e20941653f5e029c9671"),  # noqa: E501
    )
