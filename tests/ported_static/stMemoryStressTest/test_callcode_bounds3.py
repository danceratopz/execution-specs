...
Ported from:
tests/static/state_tests/stMemoryStressTest/CALLCODE_Bounds3Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stMemoryStressTest/CALLCODE_Bounds3Filler.json",  # noqa: E501
    ],
)
