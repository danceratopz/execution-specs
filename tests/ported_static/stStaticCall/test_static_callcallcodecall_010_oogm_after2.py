...
Ported from:
state_tests/stStaticCall/static_callcallcodecall_010_OOGMAfter2Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticCall/static_callcallcodecall_010_OOGMAfter2Filler.json"  # noqa: E501
    ],
)
