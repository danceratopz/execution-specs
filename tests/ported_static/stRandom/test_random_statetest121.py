...
def test_random_statetest121(
    ...
    """Test_random_statetest121."""
    coinbase = Address(0x39542DA6ED57253BECEA9540C4D2F989ABF9B22A)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x39542DA6ED57253BECEA9540C4D2F989ABF9B22A),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PUSH32[0x39542DA6ED57253BECEA9540C4D2F989ABF9B22A]
        + Op.PUSH32[0x1]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x492A84CF,
    )
