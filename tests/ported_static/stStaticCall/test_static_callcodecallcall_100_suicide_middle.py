"""
Test_static_callcodecallcall_100_suicide_middle.

Ported from:
state_tests/stStaticCall/static_callcodecallcall_100_SuicideMiddleFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticCall/static_callcodecallcall_100_SuicideMiddleFiller.json"  # noqa: E501
    ],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.slow
@pytest.mark.pre_alloc_mutable
def test_static_callcodecallcall_100_suicide_middle(
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.DELEGATECALL(
                gas=0x249F0,
                address=0xCBFD6696CBC67E0593FD4AE8A6646C6AC25ECFB8,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
    ...
    addr = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xCBFD6696CBC67E0593FD4AE8A6646C6AC25ECFB8),  # noqa: E501
    )
    # Source: lll
