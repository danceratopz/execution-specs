...
Ported from:
tests/static/state_tests/stRandom/randomStatetest299Filler.json
"""
...
def test_random_statetest299(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x540813697ADF70F20906389D128BF055,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffe6f540813697adf70f20906389d128bf0"
        ),
        gas_limit=100000,
        value=440906036,
    )
    ...
    post = {
        contract: Account(storage={0: 0x540813697ADF70F20906389D128BF055}),
    }
