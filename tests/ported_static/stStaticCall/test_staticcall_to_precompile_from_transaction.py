...
Ported from:
state_tests/stStaticCall/StaticcallToPrecompileFromTransactionFiller.yml
"""
...
def test_staticcall_to_precompile_from_transaction(
    ...
    contract_0 = Address(0x51AE3045B08CAD039FBE3B12CFED590E93B1176D)
    sender = EOA(
    ...
    contract_0 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.SSTORE(
            key=0x1, value=Op.MOD(Op.MLOAD(offset=0x3E8), Op.EXP(0x2, 0xA0))
        )
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0x51AE3045B08CAD039FBE3B12CFED590E93B1176D),  # noqa: E501
    )
