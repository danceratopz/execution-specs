"""
Test_static_callcodecallcall_100_oogm_after2.

Ported from:
state_tests/stStaticCall/static_callcodecallcall_100_OOGMAfter2Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticCall/static_callcodecallcall_100_OOGMAfter2Filler.json"  # noqa: E501
    ],
)
...
def test_static_callcodecallcall_100_oogm_after2(
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x18B308DF70B95BD44FC910CF31B5DC03723540BB),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.STATICCALL(
            gas=0x1D4D4,
            address=0x18B308DF70B95BD44FC910CF31B5DC03723540BB,
            args_offset=0x0,
            args_size=0x40,
            ret_offset=0x0,
            ret_size=0x40,
    ...
    addr = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0x6662FE0EA2FF368C138CB199302FD76B3CAA0A65),  # noqa: E501
    )
