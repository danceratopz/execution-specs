...
def test_random_statetest510(
    ...
    """Test_random_statetest510."""
    coinbase = Address(0x71C947B48FFAE893DD25D1199EC2899D788A7EB2)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x71C947B48FFAE893DD25D1199EC2899D788A7EB2),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x71C947B48FFAE893DD25D1199EC2899D788A7EB2]
        + Op.PREVRANDAO
        + Op.PUSH32[0x0]
        + Op.GAS
        + Op.GASLIMIT
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
