...
def test_random_statetest454(
    ...
    """Test_random_statetest454."""
    coinbase = Address(0xF3B0B5202D06419E46CEDC37B9472FFF81638E6F)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xF3B0B5202D06419E46CEDC37B9472FFF81638E6F),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xF3B0B5202D06419E46CEDC37B9472FFF81638E6F]
        + Op.EXP
        + Op.DUP5
        + Op.CALLER
        + Op.SWAP2
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=100000,
        value=0x55500EE3,
    )
