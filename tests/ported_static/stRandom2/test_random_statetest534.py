...
def test_random_statetest534(
    ...
    """Test_random_statetest534."""
    coinbase = Address(0x67F8B780508B71A6D8F4DE2CF06CDDD28FAC57C2)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x67F8B780508B71A6D8F4DE2CF06CDDD28FAC57C2),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.GASLIMIT
        + Op.NUMBER
        + Op.PUSH32[0x67F8B780508B71A6D8F4DE2CF06CDDD28FAC57C2]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x55DB76C1,
    )
