...
def test_random_statetest629(
    ...
    """Test_random_statetest629."""
    coinbase = Address(0x9D67DC2F11D8278B1535F2926CFF4147E2FB18CC)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x9D67DC2F11D8278B1535F2926CFF4147E2FB18CC),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x0]
        + Op.PUSH32[0x9D67DC2F11D8278B1535F2926CFF4147E2FB18CC]
        + Op.PUSH32[
            0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE
        ]
        + Op.PUSH32[0x9D67DC2F11D8278B1535F2926CFF4147E2FB18CC]
        + Op.GT(
            Op.PUSH32[0x9D67DC2F11D8278B1535F2926CFF4147E2FB18CC], Op.CALLVALUE
        )
        + Op.SSTORE(
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x3BCDBA80,
    )
