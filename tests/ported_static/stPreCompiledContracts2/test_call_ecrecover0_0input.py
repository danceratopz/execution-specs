...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stPreCompiledContracts2/CallEcrecover0_0inputFiller.json",  # noqa: E501
    ],
)
...
def test_call_ecrecover0_0input(
    ...
    contract = pre.deploy_contract(
        ...
        balance=0x1312D00,
        nonce=0,
        address=Address("0x6988d3cd2c65677341d1e302439627344dfb1c82"),  # noqa: E501
    )
