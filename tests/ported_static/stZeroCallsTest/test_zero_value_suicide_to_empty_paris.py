...
Ported from:
state_tests/stZeroCallsTest/ZeroValue_SUICIDE_ToEmpty_ParisFiller.json
"""
...
def test_zero_value_suicide_to_empty_paris(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0xEAD720895580EC7CB65D03800A2816FA7B86355E),  # noqa: E501
    )
