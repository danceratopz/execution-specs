...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest512Filler.json
"""
...
def test_random_statetest512(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x3B5BFF40567097749951500263449255,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000c350437fffffffffffffffffffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffffff6f3b5bff405670977499515002634492"
        ),
        gas_limit=100000,
        value=871411208,
    )
    ...
    post = {
        contract: Account(storage={0: 0x3B5BFF40567097749951500263449255}),
    }
