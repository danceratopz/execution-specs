"""
Test_call_ecrecover_v_prefixed0.
...
@pytest.mark.ported_from(
    [
        "state_tests/stPreCompiledContracts2/CallEcrecoverV_prefixed0Filler.json"  # noqa: E501
    ],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.pre_alloc_mutable
def test_call_ecrecover_v_prefixed0(
    state_test: StateTestFiller,
    pre: Alloc,
) -> None:
    """Test_call_ecrecover_v_prefixed0."""
    coinbase = Address(0x2ADC25665018AA1FE0E6BC666DAC8FC2697FF9BA)
    contract_0 = Address(0x2D50E0F8F17F58DEB865899F6D43F8B281E0212E)
    sender = EOA(
    ...
    contract_0 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x1312D00,
        nonce=0,
        address=Address(0x2D50E0F8F17F58DEB865899F6D43F8B281E0212E),  # noqa: E501
    )
