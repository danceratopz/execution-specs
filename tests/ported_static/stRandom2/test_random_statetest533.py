...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest533Filler.json
"""
...
def test_random_statetest533(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x6905ebd1d92150c8abd7e0edc3ca2e570143a674"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000001847f00000000000000000000000100000000"  # noqa: E501
            "000000000000000000000000000000003a076152"
        ),
        gas_limit=100000,
        value=1893110004,
    )
    ...
    post = {
        contract: Account(storage={0: 21077}),
    }
