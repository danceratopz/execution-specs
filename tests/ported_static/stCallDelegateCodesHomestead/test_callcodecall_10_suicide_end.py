...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcodecall_10_SuicideEndFiller.json"  # noqa: E501
    ],
)
...
def test_callcodecall_10_suicide_end(
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x0F7531DC09D3DF5EE8AB122F17F7431B486E3A22),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.DELEGATECALL(
                address=0xECBCC8CE8D898280F53E06B14CA1AF3DD3454243,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        nonce=0,
        address=Address(0x4CDCDA142BA43D366212C1969D985C1F9BFA0C25),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            key=0x1,
            value=Op.CALL(
                address=0x0F7531DC09D3DF5EE8AB122F17F7431B486E3A22,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        + Op.SELFDESTRUCT(address=0x4CDCDA142BA43D366212C1969D985C1F9BFA0C25)
        + Op.STOP,
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xECBCC8CE8D898280F53E06B14CA1AF3DD3454243),  # noqa: E501
    )
    ...
    post = {
        ...
        addr_2: Account(storage={2: 1, 3: 0}),
    }
