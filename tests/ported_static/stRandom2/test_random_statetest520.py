...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest520Filler.json
"""
...
def test_random_statetest520(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000017f000000000000000000000000ffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffff190308"
        ),
        gas_limit=100000,
        value=333039523,
    )
