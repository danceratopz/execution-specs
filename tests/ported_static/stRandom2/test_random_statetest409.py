...
def test_random_statetest409(
    ...
    """Test_random_statetest409."""
    coinbase = Address(0xF992CCF221F42CC717F7018BA7D548197C3D8518)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xF992CCF221F42CC717F7018BA7D548197C3D8518),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xF992CCF221F42CC717F7018BA7D548197C3D8518]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
