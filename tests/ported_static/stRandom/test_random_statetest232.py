...
Ported from:
tests/static/state_tests/stRandom/randomStatetest232Filler.json
"""
...
def test_random_statetest232(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffff0945415883ff9d7760005155"  # noqa: E501
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffffffffffffffff7fffffffffffffffff"  # noqa: E501
            "fffffffffffffffffffffffffffffffffffffffffffffffe7fffffffffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffffffffffffffff0945415883ff9d77"
        ),
        gas_limit=100000,
        value=2122038787,
    )
