...
def test_random_statetest298(
    ...
    """Test_random_statetest298."""
    coinbase = Address(0x12D0B6912CE9CC32FB67709B974F064136C46B1F)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x12D0B6912CE9CC32FB67709B974F064136C46B1F),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x12D0B6912CE9CC32FB67709B974F064136C46B1F]
        + Op.PUSH32[0x0]
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x7E0F660B,
    )
