...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stLogTests/log2_nonEmptyMem_logMemSize1_logMemStart31Filler.json",  # noqa: E501
    ],
)
...
def test_log2_non_empty_mem_log_mem_size1_log_mem_start31(
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0x3E8,
                    address=0x54972C7257A6C4CDC7C3C144E8CCB3D8EB7AFE19,
                    value=0x17,
                    args_offset=0x0,
                    args_size=0x0,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address("0x54972c7257a6c4cdc7c3c144e8ccb3d8eb7afe19"),  # noqa: E501
    )
