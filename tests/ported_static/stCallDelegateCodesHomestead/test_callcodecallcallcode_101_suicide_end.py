...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesHomestead/callcodecallcallcode_101_SuicideEndFiller.json"  # noqa: E501
    ],
)
...
def test_callcodecallcallcode_101_suicide_end(
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x02EEAB87A0CC7E51005C77D9144C1A439517D5FB),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.DELEGATECALL(
                address=0x7CB0B22309727A9566ACB83753101A4A0E9F815E,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        nonce=0,
        address=Address(0x0A5DA286E4B2F4FB44A136A0182C19F8743F5DA1),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            key=0x1,
            value=Op.CALL(
                address=0x2ED44F3B06E19DA5A581909367139E28DBA4E7FE,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x7CB0B22309727A9566ACB83753101A4A0E9F815E),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            key=0x2,
            value=Op.DELEGATECALL(
                address=0x02EEAB87A0CC7E51005C77D9144C1A439517D5FB,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        + Op.SELFDESTRUCT(address=0x7CB0B22309727A9566ACB83753101A4A0E9F815E)
        + Op.STOP,
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x2ED44F3B06E19DA5A581909367139E28DBA4E7FE),  # noqa: E501
    )
    ...
    post = {
        ...
        addr_2: Account(storage={2: 1, 3: 1}, balance=0),
