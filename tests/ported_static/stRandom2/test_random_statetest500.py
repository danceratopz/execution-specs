...
def test_random_statetest500(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x87196584968A97046C67919931148255,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000ffffffffffffffffffffffffffffffffffffffff817fffffffffffffff"  # noqa: E501
            ...
            "ffffffffffffffffffffffffffffffffffffff6f87196584968a97046c679199311482"  # noqa: E501
        ),
        gas_limit=100000,
        value=34424143,
    )
    ...
    post = {
        contract: Account(storage={0: 0x87196584968A97046C67919931148255}),
    }
