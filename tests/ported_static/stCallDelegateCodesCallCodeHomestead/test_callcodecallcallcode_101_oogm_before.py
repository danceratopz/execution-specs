"""
DELEGATE -> CALLCODE -> OOG DELEGATE -> CODE.
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesCallCodeHomestead/callcodecallcallcode_101_OOGMBeforeFiller.json",  # noqa: E501
    ],
)
...
def test_callcodecallcallcode_101_oogm_before(
    ...
    pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x71e7e95d2dfe9f65b4522f2d3aa71fb33f49920c"),  # noqa: E501
    )
    pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALLCODE(
                    gas=0x927C0,
                    address=0x71E7E95D2DFE9F65B4522F2D3AA71FB33F49920C,
                    value=0x0,
                    args_offset=0x0,
                    args_size=0x40,
                    ret_offset=0x0,
