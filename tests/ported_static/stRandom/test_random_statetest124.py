...
Ported from:
tests/static/state_tests/stRandom/randomStatetest124Filler.json
"""
...
def test_random_statetest124(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffe08125580355b17457f7463587b9a7a435560005155"  # noqa: E501
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffff7fffffffffffffffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffffffffff7fffffffffffffffffffffffffffffffffff"  # noqa: E501
            "fffffffffffffffffffffffffffffe08125580355b17457f7463587b9a7a43"
        ),
        gas_limit=100000,
        value=1751381635,
    )
