...
def test_random_statetest487(
    ...
    """Test_random_statetest487."""
    coinbase = Address(0x40844DF9D9C05EB6E309ED5291174EA965A57A74)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x40844DF9D9C05EB6E309ED5291174EA965A57A74),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
