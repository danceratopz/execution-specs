...
Ported from:
state_tests/stStaticFlagEnabled/DelegatecallToPrecompileFromTransactionFiller.yml
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticFlagEnabled/DelegatecallToPrecompileFromTransactionFiller.yml"  # noqa: E501
    ],
)
