...
Ported from:
tests/static/state_tests/stRandom/randomStatetest173Filler.json
"""
...
def test_random_statetest173(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000001447fffffffffffffffffffff"  # noqa: E501
            ...
            "96065b2a98b57a48a06ae28d285a71b509ff979443703ca35560005155"
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffffff7fffffffffffffffffffffffffff"  # noqa: E501
            "fffffffffffffffffffffffffffffffffffffe7f000000000000000000000000945304eb"  # noqa: E501
            "96065b2a98b57a48a06ae28d285a71b509ff979443703ca3"
        ),
        gas_limit=100000,
        value=1285346393,
    )
