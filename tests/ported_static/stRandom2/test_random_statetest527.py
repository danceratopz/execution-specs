...
def test_random_statetest527(
    ...
    """Test_random_statetest527."""
    coinbase = Address(0x0926AD74207EDBB5E972FD9BAEB684B0851298A6)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x0926AD74207EDBB5E972FD9BAEB684B0851298A6),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF]
        + Op.PUSH32[0x1]
        + Op.PUSH32[0x0926AD74207EDBB5E972FD9BAEB684B0851298A6]
        + Op.LOG1(
            offset=Op.DUP1,
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=100000,
        value=0xAB00B0E,
    )
