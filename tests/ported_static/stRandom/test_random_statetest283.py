...
def test_random_statetest283(
    ...
    """Test_random_statetest283."""
    coinbase = Address(0x1379693750FB1682883FD4004C7BA921F336CC3E)
    sender = EOA(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.SSTORE,
        nonce=0,
        address=Address(0xB0FED7C51FFD374EEDCE2AD9257312A169A19E51),  # noqa: E501
    )
    # Source: raw
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x1379693750FB1682883FD4004C7BA921F336CC3E),  # noqa: E501
    )
