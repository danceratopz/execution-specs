...
def test_random_statetest112(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x549C5779398A848C3530751465054155,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffffffffff45447fffffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffffffffffffffffffff7f000000000000000000000000"  # noqa: E501
            "00000000000000000000000000000000000000006f549c5779398a848c35307514650541"  # noqa: E501
        ),
        gas_limit=100000,
        value=2006825126,
    )
    ...
    post = {
        contract: Account(storage={0: 0x549C5779398A848C3530751465054155}),
    }
