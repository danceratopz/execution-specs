...
Ported from:
tests/static/state_tests/stRandom/randomStatetest382Filler.json
"""
...
def test_random_statetest382(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffe7fffffffffffffffffffffffffffffffffffffffff"  # noqa: E501
            "fffffffffffffffffffffffe08"
        ),
        gas_limit=100000,
        value=883821556,
    )
