...
Ported from:
tests/static/state_tests/stSolidityTest/RecursiveCreateContractsFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stSolidityTest/RecursiveCreateContractsFiller.json",  # noqa: E501
    ],
)
