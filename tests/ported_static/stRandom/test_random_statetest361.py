...
def test_random_statetest361(
    ...
    """Test_random_statetest361."""
    coinbase = Address(0x70D01C0C02A9EF5F3BDCC60BA37204F088B82263)
    sender = EOA(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.SSTORE(
            key=Op.MLOAD(offset=0x0), value=0x9E9092673A8F430B6BA1152090181655
        ),
        nonce=0,
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x70D01C0C02A9EF5F3BDCC60BA37204F088B82263),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x74BA18BD,
    )
