...
def test_random_statetest318(
    ...
    """Test_random_statetest318."""
    coinbase = Address(0x03E9EC8EBC12605B74D05AD443B78792E31ED036)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x03E9EC8EBC12605B74D05AD443B78792E31ED036),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xC350]
        + Op.GASLIMIT
        + Op.PUSH32[0x03E9EC8EBC12605B74D05AD443B78792E31ED036]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x23F9C6F7,
    )
