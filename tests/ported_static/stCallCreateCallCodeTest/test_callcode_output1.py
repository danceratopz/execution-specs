...
Ported from:
tests/static/state_tests/stCallCreateCallCodeTest/callcodeOutput1Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCreateCallCodeTest/callcodeOutput1Filler.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Byzantium")
@pytest.mark.pre_alloc_mutable
def test_callcode_output1(
