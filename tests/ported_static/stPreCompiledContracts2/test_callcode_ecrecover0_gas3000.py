"""
Test_callcode_ecrecover0_gas3000.

Ported from:
state_tests/stPreCompiledContracts2/CALLCODEEcrecover0_gas3000Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stPreCompiledContracts2/CALLCODEEcrecover0_gas3000Filler.json"  # noqa: E501
    ],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.pre_alloc_mutable
def test_callcode_ecrecover0_gas3000(
    state_test: StateTestFiller,
    pre: Alloc,
) -> None:
    """Test_callcode_ecrecover0_gas3000."""
    coinbase = Address(0x2ADC25665018AA1FE0E6BC666DAC8FC2697FF9BA)
    contract_0 = Address(0x30EBC3B73EEA4128C7BB04BB859E9B12B93DC188)
    sender = EOA(
    ...
    # Source: lll
    # { (MSTORE 0 0x18c547e4f7b0f325ad1e56f57e26c745b09a3e503d86e00e5255ff7f715d3d1c) (MSTORE 32 28) (MSTORE 64 0x73b1693892219d736caba55bdb67216e485557ea6b6af75f37096c9aa6a5a75f) (MSTORE 96 0xeeb940b1d03b21e36b0e47e79769f095fe2ab855bd91e3a38756b7d75a9c4549) [[ 2 ]] (CALLCODE 3000 1 0 0 128 128 32) [[ 0 ]] (MOD (MLOAD 128) (EXP 2 160)) [[ 1 ]] (EQ (ORIGIN) (SLOAD 0))  }  # noqa: E501
    contract_0 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x1312D00,
        nonce=0,
        address=Address(0x30EBC3B73EEA4128C7BB04BB859E9B12B93DC188),  # noqa: E501
    )
