...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest599Filler.json
"""
...
def test_random_statetest599(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x8D6C60440A44449372068A976A838255,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffff6f8d6c60440a44449372068a976a8382"
        ),
        gas_limit=100000,
        value=1108427958,
    )
    ...
    post = {
        contract: Account(storage={0: 0x8D6C60440A44449372068A976A838255}),
    }
