...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest485Filler.json
"""
...
def test_random_statetest485(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "0100000000000000000000000000000000000000008e447f000000000000000000000001"  # noqa: E501
            "00000000000000000000000000000000000000003a1a7e"
        ),
        nonce=0,
        address=Address("0x91a7cc63f8bb623d64fe789d8cc49c06427bb9c2"),  # noqa: E501
    )
