...
Ported from:
tests/static/state_tests/stRandom/randomStatetest212Filler.json
"""
...
def test_random_statetest212(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                key=Op.MLOAD(offset=0xF28E61990A52556000),
                value=Op.GASPRICE,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000000000017f000000000000000000000000ffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffff7fffffffffffffffffffffffffffffffffffffffff"  # noqa: E501
            "fffffffffffffffffffffffe06180908ff3a68f28e61990a52"
        ),
        gas_limit=100000,
        value=49732651,
    )
