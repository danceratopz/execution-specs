...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest466Filler.json
"""
...
def test_random_statetest466(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000ffffffffffffffffffffffffffffffffffffffff424490424404"  # noqa: E501
        ),
        gas_limit=14265563,
        value=1790975802,
    )
    ...
    post = {
        contract: Account(storage={0: 0x20000, 131: 1000}),
    }
