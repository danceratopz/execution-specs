...
def test_random_statetest604(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x7619f7a13ba66bb3e74b1d609bc4c979fdfda283"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffffffffffffe44a4418a83039c0587363b"  # noqa: E501
            "0518204006065a06"
        ),
        gas_limit=100000,
        value=1287981996,
