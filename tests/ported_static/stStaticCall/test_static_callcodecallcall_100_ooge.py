"""
Test_static_callcodecallcall_100_ooge.

Ported from:
state_tests/stStaticCall/static_callcodecallcall_100_OOGEFiller.json
"""
...
def test_static_callcodecallcall_100_ooge(
    ...
    # Source: lll
    # {  (STATICCALL 20020 (CALLDATALOAD 32) 0 64 0 64 ) (MSTORE 3 1) }
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0xB66AE4844F957380ABCB435B278E839299123A5E),  # noqa: E501
    )
    # Source: lll
    ...
    addr_4 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0x87DCDA85CD3BD8C69B34B2C47507E289879819CD),  # noqa: E501
    )
    # Source: lll
    # {  (MSTORE 32 (CALLDATALOAD 0)) (STATICCALL 100000 <contract:0x1000000000000000000000000000000000000002> 0 64 0 64 ) (MSTORE 3 1) }  # noqa: E501
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.MSTORE(offset=0x20, value=Op.CALLDATALOAD(offset=0x0))
        + Op.POP(
            Op.STATICCALL(
                gas=0x186A0,
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0xE5383E3E989EFC0C40D1EADEE605E86DE53B72FF),  # noqa: E501
    )
