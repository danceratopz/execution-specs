...
def test_static_callcallcodecallcode_011_suicide_middle(
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x09C992FBF240BD0FC2ED54E13E827E20A928E21A),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.STATICCALL(
                gas=0x249F0,
                address=0x6DB2E447185C6ABF30C2758F2DD518BF5596708F,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        nonce=0,
        address=Address(0xD915691D1B464CA017C4988EABF12A579090C35D),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x6DB2E447185C6ABF30C2758F2DD518BF5596708F),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.SELFDESTRUCT(
            address=0xD915691D1B464CA017C4988EABF12A579090C35D
        )
        + Op.DELEGATECALL(
            gas=0xC350,
            address=0x09C992FBF240BD0FC2ED54E13E827E20A928E21A,
            args_offset=0x0,
            args_size=0x40,
            ret_offset=0x0,
            ret_size=0x40,
