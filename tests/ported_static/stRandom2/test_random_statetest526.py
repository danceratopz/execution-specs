...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest526Filler.json
"""
...
def test_random_statetest526(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000945304eb96065b2a98b57a48a06ae28d285a71b5417e7f000000000000000000"  # noqa: E501
            "000000945304eb96065b2a98b57a48a06ae28d285a71b5419e01950777810975058c746f"  # noqa: E501
        ),
        gas_limit=100000,
        value=984138850,
    )
