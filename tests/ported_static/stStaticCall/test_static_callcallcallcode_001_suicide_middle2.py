...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stStaticCall/static_callcallcallcode_001_SuicideMiddle2Filler.json",  # noqa: E501
    ],
)
...
def test_static_callcallcallcode_001_suicide_middle2(
    ...
    pre.deploy_contract(
        code=(
            Op.SELFDESTRUCT(address=0x8D1428C10723924A74AB6096C463EDAAB4CEA5FB)
            + Op.CALLCODE(
                gas=0xC350,
