...
Ported from:
tests/static/state_tests/stZeroKnowledge/ecpairing_perturb_g2_by_oneFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stZeroKnowledge/ecpairing_perturb_g2_by_oneFiller.json",  # noqa: E501
    ],
)
...
def test_ecpairing_perturb_g2_by_one(
    ...
    pre[coinbase] = Account(balance=0x5DB2A1, nonce=0)
    ...
    pre[sender] = Account(balance=0xDE0B6B3A7064D5F, nonce=24)
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "31fb5d25f1aa493335a9e71297e485b7aef312c31800deef121f1e76426a00665e5c4479"  # noqa: E501
