...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stStaticCall/static_CallEcrecoverR_prefixed0Filler.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Byzantium")
@pytest.mark.pre_alloc_mutable
@pytest.mark.slow
def test_static_call_ecrecover_r_prefixed0(
    ...
    contract = pre.deploy_contract(
        ...
        balance=0x1312D00,
        nonce=0,
        address=Address("0x2e063e550f3f9751ef9eb0da5e2b392c3ece8e6e"),  # noqa: E501
    )
