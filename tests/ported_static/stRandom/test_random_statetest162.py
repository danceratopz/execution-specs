...
Ported from:
tests/static/state_tests/stRandom/randomStatetest162Filler.json
"""
...
def test_random_statetest162(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x355A7F614497339E3B63878B36980455,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000c3507f000000000000000000000000ffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffff6f355a7f614497339e3b63878b369804"
        ),
        gas_limit=100000,
        value=725006509,
    )
    ...
    post = {
        contract: Account(storage={0: 0x355A7F614497339E3B63878B36980455}),
    }
