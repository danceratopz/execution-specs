...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stStaticCall/static_CallEcrecoverS_prefixed0Filler.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Byzantium")
@pytest.mark.pre_alloc_mutable
@pytest.mark.slow
def test_static_call_ecrecover_s_prefixed0(
    ...
    # Source: LLL
    # { (MSTORE 0 0x18c547e4f7b0f325ad1e56f57e26c745b09a3e503d86e00e5255ff7f715d3d1c) (MSTORE 32 28) (MSTORE 64 0x73b1693892219d736caba55bdb67216e485557ea6b6af75f37096c9aa6a5a75f) (MSTORE 96 0x00b940b1d03b21e36b0e47e79769f095fe2ab855bd91e3a38756b7d75a9c4549) [[ 2 ]] (STATICCALL 300000 1 0 128 128 32) [[ 0 ]] (MOD (MLOAD 128) (EXP 2 160)) [[ 1 ]] (EQ (ORIGIN) (SLOAD 0))  }  # noqa: E501
    contract = pre.deploy_contract(
        ...
        balance=0x1312D00,
        nonce=0,
        address=Address("0x200ecc0698b28ef50ee8bf150b2d7a87ed969482"),  # noqa: E501
    )
