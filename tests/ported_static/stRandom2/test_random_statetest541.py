...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest541Filler.json
"""
...
def test_random_statetest541(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x854f4406999b8bb46770d32ca10f059498717bfc"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000100000000000000000000000000000000000000004335696e089257368d07897d5735"  # noqa: E501
            "0b10"
        ),
        gas_limit=100000,
        value=525505301,
