...
def test_static_calldelcode_01_ooge(
    ...
    addr = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0xF34136BEA436A9C64B042DB8798E72AED254AE3F),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0xF8FE0304EEF64B50667747487C8E7CC1FB7F8BC7),  # noqa: E501
    )
    # Source: lll
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0xA75F37414D0870ADBD14CE43FD46D49505127D31),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.SSTORE(
            ...
            value=Op.STATICCALL(
                gas=0x249F0,
                address=0xF34136BEA436A9C64B042DB8798E72AED254AE3F,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        nonce=0,
        address=Address(0x51DC80F05CA006C522952412EA0ACE482FDEC84F),  # noqa: E501
    )
