...
def test_random_statetest410(
    ...
    """Test_random_statetest410."""
    coinbase = Address(0x490B8C306F03F4F80A4D8483ABA5D36710A6ED1B)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x490B8C306F03F4F80A4D8483ABA5D36710A6ED1B),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PUSH32[0x490B8C306F03F4F80A4D8483ABA5D36710A6ED1B]
        + Op.COINBASE
        + Op.PUSH32[0x0]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=200000,
        value=0x756B69D9,
    )
