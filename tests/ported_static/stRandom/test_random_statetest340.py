...
Ported from:
tests/static/state_tests/stRandom/randomStatetest340Filler.json
"""
...
def test_random_statetest340(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xe55b3d86c30351b3b3c173c83c73acedea2578ae"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000004f3f701464972e74606d6ea82d4d3080599a0e79547fffffffffffffff"  # noqa: E501
