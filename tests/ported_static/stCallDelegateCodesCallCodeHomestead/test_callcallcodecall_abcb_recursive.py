...
Ported from:
state_tests/stCallDelegateCodesCallCodeHomestead/callcallcodecall_ABCB_RECURSIVEFiller.json
"""
...
def test_callcallcodecall_abcb_recursive(
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0x17D7840,
                address=0xF0E731ED5923A09E454C6E96D7DB40C8123CF91E,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0x2A6CCCC6CC222961F0CCB60FA864D60F780D874D),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.DELEGATECALL(
                gas=0xF4240,
                address=0xC3B5D1259AC864EBF62EC78149199915B4580A7F,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xF0E731ED5923A09E454C6E96D7DB40C8123CF91E),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xC3B5D1259AC864EBF62EC78149199915B4580A7F),  # noqa: E501
    )
