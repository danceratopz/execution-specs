...
def test_random_statetest220(
    ...
    """Test_random_statetest220."""
    coinbase = Address(0x04A1FEBA47D0F6BFA124F894A65A67C28893E693)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x04A1FEBA47D0F6BFA124F894A65A67C28893E693),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x04A1FEBA47D0F6BFA124F894A65A67C28893E693]
        + Op.PUSH32[
            0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
        ]
        + Op.PUSH32[0x1] * 2
        + Op.SSTORE(
            key=Op.MLOAD(offset=0x0), value=0x420380A03C4282A3540A1A333A843A55
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0xC5BFC9F,
    )
