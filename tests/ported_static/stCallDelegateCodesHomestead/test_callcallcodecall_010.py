...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesHomestead/callcallcodecall_010Filler.json",  # noqa: E501
    ],
)
...
def test_callcallcodecall_010(
    ...
    pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xa297e445dc76a67bf6fc17c444c1ec2c389ce53d"),  # noqa: E501
    )
    # Source: LLL
        ...
        code=(
            Op.SSTORE(
                ...
                value=Op.DELEGATECALL(
                    gas=0x493E0,
                    address=0xA297E445DC76A67BF6FC17C444C1EC2C389CE53D,
                    args_offset=0x0,
                    args_size=0x40,
                    ret_offset=0x0,
                    ret_size=0x40,
