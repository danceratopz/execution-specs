...
Ported from:
state_tests/stCallCodes/callcallcodecallcode_ABCB_RECURSIVEFiller.json
"""
...
def test_callcallcodecallcode_abcb_recursive(
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALL(
                gas=0x17D7840,
                address=0x051A786D7ECF19C7C95B989A0A5D6C25D1A3ECF4,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0xFA27CE8BC63606E9522945228FA9B6B5E14C53E7),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0xF4240,
                address=0xE80C8C2A857E28AB6125196E540979A280427A56,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x051A786D7ECF19C7C95B989A0A5D6C25D1A3ECF4),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xE80C8C2A857E28AB6125196E540979A280427A56),  # noqa: E501
    )
