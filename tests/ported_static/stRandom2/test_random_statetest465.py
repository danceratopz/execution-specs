...
def test_random_statetest465(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x39c49de6b1821e4bf091113386607cc5533ab190"),  # noqa: E501
    )
    # Source: raw bytecode
    pre.deploy_contract(
        code=(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000004f3f701464972e74606d6ea82d4d3080599a0e79437f00000000000000000000"  # noqa: E501
