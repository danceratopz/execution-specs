...
Ported from:
tests/static/state_tests/stCallCodes/callcodecallcall_100_OOGEFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCodes/callcodecallcall_100_OOGEFiller.json",  # noqa: E501
    ],
)
