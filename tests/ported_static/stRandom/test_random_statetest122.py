"""
Test_random_statetest122.

Ported from:
state_tests/stRandom/randomStatetest122Filler.json
...
def test_random_statetest122(
    ...
    """Test_random_statetest122."""
    coinbase = Address(0x34D46F5EC4D0660AE27F4C253779DA772EF8E337)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x34D46F5EC4D0660AE27F4C253779DA772EF8E337),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PUSH32[0x34D46F5EC4D0660AE27F4C253779DA772EF8E337]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x201771A5,
    )
