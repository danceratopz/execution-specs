...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest562Filler.json
"""
...
def test_random_statetest562(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x86e63b3928d89817589609c1e2180e22939d6a62"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000001937fffffffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffffffffffffffffff7f00000000000000000000000000"  # noqa: E501
            "0000000000000000000000000000000000c350a094448744"
        ),
        gas_limit=100000,
        value=1494991145,
    )
