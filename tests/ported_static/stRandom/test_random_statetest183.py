...
def test_random_statetest183(
    ...
    """Test_random_statetest183."""
    coinbase = Address(0xAE44F2325DB1C5BAC7E8EE8CE0A2FBD43177E021)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xAE44F2325DB1C5BAC7E8EE8CE0A2FBD43177E021),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xAE44F2325DB1C5BAC7E8EE8CE0A2FBD43177E021]
        + Op.NUMBER
        + Op.SSTORE(
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x451629C1,
    )
