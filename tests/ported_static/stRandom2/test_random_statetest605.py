...
def test_random_statetest605(
    ...
    """Test_random_statetest605."""
    coinbase = Address(0xA65A6261AA33DE36771D43E31E5CC34D8A47DFFA)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xA65A6261AA33DE36771D43E31E5CC34D8A47DFFA),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xA65A6261AA33DE36771D43E31E5CC34D8A47DFFA]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x650044FA,
    )
