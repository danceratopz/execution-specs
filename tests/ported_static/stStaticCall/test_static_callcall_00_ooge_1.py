...
def test_static_callcall_00_ooge_1(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0x1FBBA4D3233B10C274070676144F4ECC7D6141E2),  # noqa: E501
    )
    # Source: lll
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0xF54F9445041B8F0C8C07D7098B129614FF285C83),  # noqa: E501
    )
    # Source: lll
    ...
    addr_6 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0x1C99A7321CEA3244CAD0295876C45229534BCDBF),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.POP(
            Op.STATICCALL(
                gas=0x186A0,
                address=0xF54F9445041B8F0C8C07D7098B129614FF285C83,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
    ...
    addr_5 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.POP(
            Op.STATICCALL(
                gas=0x186A0,
                address=0x1C99A7321CEA3244CAD0295876C45229534BCDBF,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
    ...
    addr = pre.deploy_contract(  # noqa: F841
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address(0x32AD0FF21C8239A6A94E965541E13446909C2AE0),  # noqa: E501
    )
    # Source: lll
    ...
    addr_4 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address(0xE00D34310DDD175D4F3C8E82DD7D8850BD441EF6),  # noqa: E501
    )
