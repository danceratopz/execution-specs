...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest452Filler.json
"""
...
def test_random_statetest452(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0xA3289746806163630047DFF98310555,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "606d6ea82d4d3080599a0e796f0a3289746806163630047dff983105"
        ),
        gas_limit=100000,
        value=1492613506,
    )
    ...
    post = {
        contract: Account(storage={0: 0xA3289746806163630047DFF98310555}),
    }
