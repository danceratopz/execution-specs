...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest488Filler.json
"""
...
def test_random_statetest488(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x3250648093577F6364A218F0907E7D55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffe6f3250648093577f6364a218f0907e7d"  # noqa: E501
        ),
        gas_limit=100000,
        value=1401176215,
    )
    ...
    post = {
        contract: Account(storage={0: 0x3250648093577F6364A218F0907E7D55}),
    }
