...
Ported from:
tests/static/state_tests/stRandom/randomStatetest279Filler.json
"""
...
def test_random_statetest279(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x35596aa142f6fc0097b6fbe0d02a4e1cb3b7b043"),  # noqa: E501
    )
    # Source: raw bytecode
    pre.deploy_contract(
        code=(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000947f0000000000000000000000004f3f7014"  # noqa: E501
