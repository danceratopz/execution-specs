...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest386Filler.json
"""
...
def test_random_statetest386(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xc36f24a2628ca6bf3d13fb8e6090844962dfbb86"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffff047f00000000000000000000000000000000"  # noqa: E501
            "0000000000000000000000000000000105133641010b8111"
        ),
        gas_limit=100000,
        value=433564740,
    )
