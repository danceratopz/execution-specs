...
Ported from:
tests/static/state_tests/stStaticCall/static_CallEcrecover2Filler.json
"""
...
@pytest.mark.slow
def test_static_call_ecrecover2(
    ...
    contract = pre.deploy_contract(
        ...
        balance=0x1312D00,
        nonce=0,
        address=Address("0x77c4dedd873bb751217a744a41ccc43a37e0859e"),  # noqa: E501
    )
