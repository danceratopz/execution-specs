...
Ported from:
tests/static/state_tests/stLogTests/log4_nonEmptyMem_logMemSize1Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stLogTests/log4_nonEmptyMem_logMemSize1Filler.json",  # noqa: E501
    ],
)
...
def test_log4_non_empty_mem_log_mem_size1(
    ...
    pre.deploy_contract(
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address("0xa1ba9edcb02902136b7a79a5c49409e244bc01c5"),  # noqa: E501
    )
