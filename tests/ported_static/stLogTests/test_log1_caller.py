...
Ported from:
tests/static/state_tests/stLogTests/log1_CallerFiller.json
"""
...
def test_log1_caller(
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0x3E8,
                    address=0x488E90E8584A9B411FD53CFBB85544DE674BB24F,
                    value=0x17,
                    args_offset=0x0,
                    args_size=0x0,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address("0x488e90e8584a9b411fd53cfbb85544de674bb24f"),  # noqa: E501
    )
