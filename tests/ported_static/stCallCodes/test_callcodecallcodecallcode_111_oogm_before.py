"""
callcode -> callcode -> (OOG) callcode -> code.
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCodes/callcodecallcodecallcode_111_OOGMBeforeFiller.json",  # noqa: E501
    ],
)
...
def test_callcodecallcodecallcode_111_oogm_before(
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALLCODE(
                    gas=0xC3500,
                    address=0xA4173498C0DA91570D8AF9A128C337A67A6B4E69,
                    value=0x0,
                    args_offset=0x0,
                    args_size=0x40,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALLCODE(
                    gas=0x927C0,
                    address=0xDBB53599A5D13E0C465E1CC4FF24D7F00D780DF4,
                    value=0x0,
                    args_offset=0x0,
                    args_size=0x40,
                    ret_offset=0x0,
        ...
        nonce=0,
        address=Address("0xa4173498c0da91570d8af9a128c337a67a6b4e69"),  # noqa: E501
    )
    pre.deploy_contract(
    ...
    pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xdbb53599a5d13e0c465e1cc4ff24d7f00d780df4"),  # noqa: E501
    )
