...
def test_random_statetest418(
    ...
    """Test_random_statetest418."""
    coinbase = Address(0xCF1C51AA3BCCE988A0D0B9D3E56EA3CBF022F85A)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xCF1C51AA3BCCE988A0D0B9D3E56EA3CBF022F85A),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.LOG3(
            ...
            topic_2=Op.PUSH32[0xCF1C51AA3BCCE988A0D0B9D3E56EA3CBF022F85A],
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=392462029,
        value=0x65A87A48,
    )
