...
Ported from:
tests/static/state_tests/stPreCompiledContracts2/CALLCODEEcrecover2Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stPreCompiledContracts2/CALLCODEEcrecover2Filler.json",  # noqa: E501
    ],
)
