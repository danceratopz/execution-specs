...
def test_random_statetest603(
    ...
    """Test_random_statetest603."""
    coinbase = Address(0xBEA1118D1D3DC1DE98676B1342CF9B2C2A205877)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xBEA1118D1D3DC1DE98676B1342CF9B2C2A205877),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xBEA1118D1D3DC1DE98676B1342CF9B2C2A205877]
        + Op.TIMESTAMP
        + Op.PUSH32[0xBEA1118D1D3DC1DE98676B1342CF9B2C2A205877]
        + Op.ADDMOD(
            Op.PUSH32[0xBEA1118D1D3DC1DE98676B1342CF9B2C2A205877],
        ...
        nonce=0,
        address=Address(0x503333F6D5DDC17E393A7A209DB4CF7842CE6D94),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x23FCF7F2,
    )
