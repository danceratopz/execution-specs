...
Ported from:
tests/static/state_tests/stRevertTest/RevertPrefoundEmptyCall_ParisFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stRevertTest/RevertPrefoundEmptyCall_ParisFiller.json",  # noqa: E501
    ],
)
