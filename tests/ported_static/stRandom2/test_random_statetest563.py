...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest563Filler.json
"""
...
def test_random_statetest563(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffffffffffe418b7f000000000000000000"  # noqa: E501
            "000000ffffffffffffffffffffffffffffffffffffffff7f000000000000000000000000"  # noqa: E501
            "4f3f701464972e74606d6ea82d4d3080599a0e790461098038315ba267"
        ),
        nonce=0,
        address=Address("0x2f5f042c5d61da63b8afa98d3502ff4b4950c22b"),  # noqa: E501
    )
    # Source: raw bytecode
    pre.deploy_contract(
        code=(
