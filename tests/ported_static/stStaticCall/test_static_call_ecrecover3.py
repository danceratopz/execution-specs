...
Ported from:
tests/static/state_tests/stStaticCall/static_CallEcrecover3Filler.json
"""
...
@pytest.mark.slow
def test_static_call_ecrecover3(
    ...
    # Source: LLL
    # { (MSTORE 0 0x2f380a2dea7e778d81affc2443403b8fe4644db442ae4862ff5bb3732829cdb9) (MSTORE 32 27) (MSTORE 64 0x6b65ccb0558806e9b097f27a396d08f964e37b8b7af6ceeb516ff86739fbea0a) (MSTORE 96 0x37cbc8d883e129a4b1ef9d5f1df53c4f21a3ef147cf2a50a4ede0eb06ce092d4) [[ 2 ]] (STATICCALL 100000 1 0 128 128 32) [[ 0 ]] (MOD (MLOAD 128) (EXP 2 160)) [[ 1 ]] (EQ (ORIGIN) (SLOAD 0))  }  # noqa: E501
    contract = pre.deploy_contract(
        ...
        balance=0x1312D00,
        nonce=0,
        address=Address("0xc2f38613f26b4b1c6de179462718c7e67c175419"),  # noqa: E501
    )
