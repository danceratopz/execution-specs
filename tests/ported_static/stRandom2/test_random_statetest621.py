...
def test_random_statetest621(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x3BA187A19366899E595220741232905B,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000000441a7f000000000000000000"  # noqa: E501
            "000000ffffffffffffffffffffffffffffffffffffffff6f3ba187a19366899e59522074"  # noqa: E501
            "1232905b"
        ),
        gas_limit=100000,
        value=2143896087,
    ...
    post = {
        contract: Account(storage={0: 0x3BA187A19366899E595220741232905B}),
    }
