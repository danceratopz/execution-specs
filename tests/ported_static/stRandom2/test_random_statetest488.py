...
def test_random_statetest488(
    ...
    """Test_random_statetest488."""
    coinbase = Address(0x35FA1495EC58458392D8253EBF2874CC1335F30C)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x35FA1495EC58458392D8253EBF2874CC1335F30C),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x35FA1495EC58458392D8253EBF2874CC1335F30C] * 2
        + Op.TIMESTAMP
        + Op.PUSH32[0x0]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x53844097,
    )
