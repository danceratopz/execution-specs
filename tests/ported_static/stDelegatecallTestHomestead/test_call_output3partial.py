"""
Test_call_output3partial.

Ported from:
state_tests/stDelegatecallTestHomestead/callOutput3partialFiller.json
"""
...
def test_call_output3partial(
    ...
    addr = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0xAE930EE573C35FA504F08D90683A9DD7CCCA7D88),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address(0xBE700438D5CD6B470410B05210F9E5B8345D4052),  # noqa: E501
    )
