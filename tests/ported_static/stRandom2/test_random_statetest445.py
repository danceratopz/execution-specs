...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest445Filler.json
"""
...
def test_random_statetest445(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "0000000000000000000000008756993365a1376155"
        ),
        nonce=0,
        address=Address("0xdf00487753fafb7d8ac061b9f2fbe3488f0d83d7"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffe7f000000000000000000000000ffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffff7f0000000000000000000000000000000000000000"  # noqa: E501
            "0000000000000000000000008756993365a13761"
        ),
        gas_limit=100000,
        value=340638033,
    )
