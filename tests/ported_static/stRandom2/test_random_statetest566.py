...
def test_random_statetest566(
    ...
    """Test_random_statetest566."""
    coinbase = Address(0x7956C3DB31FCD650851D3A2D305EF0CB21633BE6)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x7956C3DB31FCD650851D3A2D305EF0CB21633BE6),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.TIMESTAMP
        + Op.PUSH32[0x7956C3DB31FCD650851D3A2D305EF0CB21633BE6]
        + Op.SWAP4
        + Op.SWAP7
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=100000,
        value=0x21B918F0,
    )
