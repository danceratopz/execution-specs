...
Ported from:
tests/static/state_tests/stRandom/randomStatetest116Filler.json
"""
...
def test_random_statetest116(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffffe457fffffffffffffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffffffffffff7f0000000000000000000000004f3f7014"  # noqa: E501
            "64972e74606d6ea82d4d3080599a0e7907539337"
        ),
        gas_limit=100000,
        value=372067975,
    )
