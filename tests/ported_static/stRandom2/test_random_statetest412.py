...
def test_random_statetest412(
    ...
    """Test_random_statetest412."""
    coinbase = Address(0x6958192D9ED549D4AC9F60CA1BCAA0813661E9BE)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x6958192D9ED549D4AC9F60CA1BCAA0813661E9BE),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PUSH32[0x6958192D9ED549D4AC9F60CA1BCAA0813661E9BE]
        + Op.PUSH32[0xC350]
        + Op.PUSH32[0x6958192D9ED549D4AC9F60CA1BCAA0813661E9BE] * 2
        + Op.PUSH32[0x1] * 2
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x75CF6AD,
    )
