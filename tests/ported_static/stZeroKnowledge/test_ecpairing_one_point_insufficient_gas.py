...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stZeroKnowledge/ecpairing_one_point_insufficient_gasFiller.json",  # noqa: E501
    ],
)
...
def test_ecpairing_one_point_insufficient_gas(
    ...
    pre[coinbase] = Account(balance=0x60E86, nonce=0)
