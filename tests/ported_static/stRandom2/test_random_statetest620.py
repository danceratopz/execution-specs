"""
Test_random_statetest620.

Ported from:
state_tests/stRandom2/randomStatetest620Filler.json
...
def test_random_statetest620(
    ...
    """Test_random_statetest620."""
    coinbase = Address(0xC408412109CE45A3415E81BAD0B18275ECA2250E)
    sender = EOA(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.SSTORE(
            key=Op.MLOAD(offset=0x0), value=0x6C54A420327D73727D9D1A667BF38955
        ),
        nonce=0,
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xC408412109CE45A3415E81BAD0B18275ECA2250E),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x61F75E26,
    )
