...
Ported from:
tests/static/state_tests/stRandom/randomStatetest17Filler.json
"""
...
def test_random_statetest17(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.CALLDATACOPY(
                ...
                offset=Op.MOD(
                    Op.PUSH32[0x1], Op.EXP(Op.NUMBER, Op.PUSH32[0x1])
                ),
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000000000000000001427f00000000"  # noqa: E501
            "0000000000000000000000000000000000000000000000000000c3507f00000000000000"  # noqa: E501
            "00000000000000000000000000000000000000000000000001430a7f0000000000000000"  # noqa: E501
            "00000000000000000000000000000000000000000000000106813b37"
        ),
        gas_limit=100000,
        value=1639312514,
    )
