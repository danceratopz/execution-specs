...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest384Filler.json
"""
...
def test_random_statetest384(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x16133502727C0A7F679B456DF0935763,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffff6f16133502727c0a7f679b456df0935763"
        ),
        gas_limit=100000,
        value=2066470732,
    )
    ...
    post = {
        contract: Account(storage={0: 0x16133502727C0A7F679B456DF0935763}),
    }
