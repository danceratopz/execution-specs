"""
CALLCODE -> CALLCODE2 -> CALLCODE3 -> CALLCODE2 -> ...  the gas usage...
...
@pytest.mark.ported_from(
    [
        "state_tests/stCallCodes/callcodecallcodecallcode_ABCB_RECURSIVEFiller.json"  # noqa: E501
    ],
)
...
def test_callcodecallcodecallcode_abcb_recursive(
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0x17D7840,
                address=0x2DF4659CF91D8F8DDD575FBBCDBA6DD6FCD312EA,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0xBDDF41F12BDDD8F58C2013F89E697845D517CDE2),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0xF4240,
                address=0xBD38628D762BCCDC2BF3529B31B5B8B57A536FA9,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x2DF4659CF91D8F8DDD575FBBCDBA6DD6FCD312EA),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xBD38628D762BCCDC2BF3529B31B5B8B57A536FA9),  # noqa: E501
    )
