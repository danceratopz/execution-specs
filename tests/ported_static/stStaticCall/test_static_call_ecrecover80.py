...
Ported from:
tests/static/state_tests/stStaticCall/static_CallEcrecover80Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stStaticCall/static_CallEcrecover80Filler.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Byzantium")
@pytest.mark.pre_alloc_mutable
@pytest.mark.slow
def test_static_call_ecrecover80(
