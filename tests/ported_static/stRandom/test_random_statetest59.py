...
def test_random_statetest59(
    ...
    """Test_random_statetest59."""
    coinbase = Address(0x47EDEA68BA212FF0BAE87680710C1A6A176A4A36)
    sender = EOA(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x819695593912E3C55CDAE6AE7FA84DCE409C7817),  # noqa: E501
    )
    # Source: raw
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x47EDEA68BA212FF0BAE87680710C1A6A176A4A36),  # noqa: E501
    )
