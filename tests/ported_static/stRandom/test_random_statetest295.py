...
Ported from:
tests/static/state_tests/stRandom/randomStatetest295Filler.json
"""
...
def test_random_statetest295(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "606d6ea82d4d3080599a0e7931353a0b3c8b17eb55"
        ),
        nonce=0,
        address=Address("0x8b2cf534e72a2af416b63fae177d57dedaeec9e9"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffff7f0000000000000000000000000000000000"  # noqa: E501
            "00000000000000000000000000c3507f0000000000000000000000004f3f701464972e74"  # noqa: E501
            "606d6ea82d4d3080599a0e7931353a0b3c8b17eb"
        ),
        gas_limit=100000,
        value=587483939,
    )
