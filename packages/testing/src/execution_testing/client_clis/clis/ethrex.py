...
class EthrexExceptionMapper(ExceptionMapper):
    ...
    mapping_substring = {
        ...
        BlockException.INVALID_REQUESTS: (
            "Requests hash does not match the one in the header "
            "after executing"
        ),
        BlockException.INVALID_RECEIPTS_ROOT: (
            "Receipts Root does not match the one in the header "
            "after executing"
        ),
        BlockException.INVALID_STATE_ROOT: (
            "World State Root does not match the one in the header "
            "after executing"
        ),
