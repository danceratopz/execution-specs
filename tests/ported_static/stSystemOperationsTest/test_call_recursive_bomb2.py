...
Ported from:
tests/static/state_tests/stSystemOperationsTest/CallRecursiveBomb2Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stSystemOperationsTest/CallRecursiveBomb2Filler.json",  # noqa: E501
    ],
)
