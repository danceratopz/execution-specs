...
def test_random_statetest430(
    ...
    """Test_random_statetest430."""
    coinbase = Address(0xE60140A34B7EEEB9620C15156826FE6194E87A81)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xE60140A34B7EEEB9620C15156826FE6194E87A81),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xC350]
        + Op.PUSH32[0xE60140A34B7EEEB9620C15156826FE6194E87A81]
        + Op.PUSH32[0x1]
        + Op.PUSH32[0x0]
        + Op.SSTORE(
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x6BF5E61F,
    )
