...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest633Filler.json
"""
...
def test_random_statetest633(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x82941340756317567250F1573A897655,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffe7fffffffffffffffffffffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffff7f0000000000000000000000004f3f701464972e74"  # noqa: E501
            "606d6ea82d4d3080599a0e796f82941340756317567250f1573a8976"
        ),
        gas_limit=100000,
        value=1358306105,
    )
    ...
    post = {
        contract: Account(storage={0: 0x82941340756317567250F1573A897655}),
    }
