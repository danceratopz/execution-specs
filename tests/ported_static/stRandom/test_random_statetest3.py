...
Ported from:
tests/static/state_tests/stRandom/randomStatetest3Filler.json
"""
...
def test_random_statetest3(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffffe427f00000000000000000000000000"  # noqa: E501
            "0000000000000000000000000000000000c35041"
        ),
        gas_limit=100000,
        value=1588208191,
    )
