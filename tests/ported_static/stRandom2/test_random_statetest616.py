...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest616Filler.json
"""
...
def test_random_statetest616(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x86A2409B991539F0423C0342363C3B55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000006f86a2409b991539f0423c0342363c3b"
        ),
        gas_limit=100000,
        value=1167366767,
    )
    ...
    post = {
        contract: Account(storage={0: 0x86A2409B991539F0423C0342363C3B55}),
    }
