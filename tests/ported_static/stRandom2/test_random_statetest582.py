...
def test_random_statetest582(
    ...
    """Test_random_statetest582."""
    coinbase = Address(0x81A0FFDFF62025DDE45A6F159F755562D2EA07E6)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x81A0FFDFF62025DDE45A6F159F755562D2EA07E6),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PUSH32[0x81A0FFDFF62025DDE45A6F159F755562D2EA07E6]
        + Op.COINBASE
        + Op.PUSH32[0x0]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=200000,
        value=0x756B69D9,
    )
