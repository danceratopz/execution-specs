...
def test_static_callcodecallcall_abcb_recursive2(
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0x17D7840,
                address=0x9C2E282C59F8E35BCDBA7765ACCEB4BFC403BBAC,
                value=Op.CALLVALUE,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0x3AB876866DDC6A6DCA4BD4795B9C499B48A6AEF4),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.STATICCALL(
            gas=0xF4240,
            address=0x9197DA5F225442D1C313EE4B3E5D40E496846DB9,
            args_offset=0x0,
            args_size=0x40,
            ret_offset=0x0,
            ret_size=0x40,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x9C2E282C59F8E35BCDBA7765ACCEB4BFC403BBAC),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x9197DA5F225442D1C313EE4B3E5D40E496846DB9),  # noqa: E501
    )
