...
def test_random_statetest615(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x1c92f41f022def89bbb572a504b90f3ba61b9e9a"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffffe837f000000000000000000000000ff"  # noqa: E501
