...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stStaticCall/static_callcodecallcallcode_101_SuicideMiddle2Filler.json",  # noqa: E501
    ],
)
...
def test_static_callcodecallcallcode_101_suicide_middle2(
    ...
    pre.deploy_contract(
        code=(
            Op.SELFDESTRUCT(address=0xCC7B2C7C17E1DD7940B1AA2F4B3E55D7BD662608)
            + Op.CALLCODE(
                gas=0xC350,
