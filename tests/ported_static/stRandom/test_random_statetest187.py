...
def test_random_statetest187(
    ...
    """Test_random_statetest187."""
    coinbase = Address(0xC1392CE27D8D38A7CDB66D126AD2DE7B9862AEFB)
    sender = EOA(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x0]
        + Op.SSTORE(
            key=Op.MLOAD(offset=0x0), value=0x75988036A0562096036B04518877199D
        ),
        nonce=0,
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xC1392CE27D8D38A7CDB66D126AD2DE7B9862AEFB),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x372E4882,
    )
