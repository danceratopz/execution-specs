...
def test_random_statetest556(
    ...
    """Test_random_statetest556."""
    coinbase = Address(0x6AE0673A07FD8CDEC6D06BAB02199264D5CCC568)
    sender = EOA(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0xFC0F78D9E0F19FC8E78CAA6A31AEE7CC3D523B5C),  # noqa: E501
    )
    # Source: raw
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x6AE0673A07FD8CDEC6D06BAB02199264D5CCC568),  # noqa: E501
    )
