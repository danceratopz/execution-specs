...
def test_random_statetest180(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x11576B693C128A9E0820609C050A219D,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000000000000000001447f00000000"  # noqa: E501
            ...
            "3f701464972e74606d6ea82d4d3080599a0e796f11576b693c128a9e0820609c050a219d"  # noqa: E501
        ),
        gas_limit=100000,
        value=566466109,
    )
    ...
    post = {
        contract: Account(storage={0: 0x11576B693C128A9E0820609C050A219D}),
    }
