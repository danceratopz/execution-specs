...
def test_random_statetest117(
    ...
    """Test_random_statetest117."""
    coinbase = Address(0x494757B848D07DBE21AA3D7D5833BC50E6694F1F)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x494757B848D07DBE21AA3D7D5833BC50E6694F1F),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PREVRANDAO
        + Op.PUSH32[0x1]
        + Op.PUSH32[0x494757B848D07DBE21AA3D7D5833BC50E6694F1F]
        + Op.TIMESTAMP
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x691AC7A4,
    )
