...
def test_random_statetest53(
    ...
    """Test_random_statetest53."""
    coinbase = Address(0xFDC7697BE68571C125CBBF600948C4293A5EF40C)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xFDC7697BE68571C125CBBF600948C4293A5EF40C),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x0]
        + Op.PUSH32[0x1]
        + Op.PUSH32[0xFDC7697BE68571C125CBBF600948C4293A5EF40C]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=4400000,
        value=0x16AB40,
    )
