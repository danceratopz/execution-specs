...
Ported from:
state_tests/stStaticCall/static_callcallcodecallcode_011_SuicideMiddle2Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticCall/static_callcallcodecallcode_011_SuicideMiddle2Filler.json"  # noqa: E501
    ],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.slow
@pytest.mark.pre_alloc_mutable
def test_static_callcallcodecallcode_011_suicide_middle2(
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.STATICCALL(
                gas=0x249F0,
                address=0xD009AF172F5FAE9CCFE64264207C2FE773E0764F,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
    ...
    addr = pre.deploy_contract(  # noqa: F841
        ...
        + Op.POP(
            Op.CALLCODE(
                gas=0x186A0,
                address=0xDCAD05283EB3153CA2200073454E8303C30805EC,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
