...
def test_callcallcallcode_001_suicide_end(
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xD6950A8C032FFFDFBEAD37487D82DB80280E1999),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            key=0x0,
            value=Op.CALL(
                address=0xC23F1F9CABB9EAA6AF7F0DEBE8C95E256EA0B247,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0x1A0D8AD371CED2EFD1B4FA6261E0A178E68444D8),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            key=0x1,
            value=Op.CALL(
                address=0x6D0FD8A22B7756780BA0ADDF5A17734D7EF4A699,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xC23F1F9CABB9EAA6AF7F0DEBE8C95E256EA0B247),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.DELEGATECALL(
                address=0xD6950A8C032FFFDFBEAD37487D82DB80280E1999,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        + Op.SELFDESTRUCT(address=0xC23F1F9CABB9EAA6AF7F0DEBE8C95E256EA0B247)
        + Op.STOP,
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x6D0FD8A22B7756780BA0ADDF5A17734D7EF4A699),  # noqa: E501
    )
