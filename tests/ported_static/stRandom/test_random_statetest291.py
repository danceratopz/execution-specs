...
def test_random_statetest291(
    ...
    """Test_random_statetest291."""
    coinbase = Address(0x1591F5D53B70F7669F3EC776DA3964BD7D19CCC0)
    sender = EOA(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.SSTORE,
        nonce=0,
        address=Address(0xA8CBFEAF9A78D390BADA18771F29715B4B54C94E),  # noqa: E501
    )
    # Source: raw
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x1591F5D53B70F7669F3EC776DA3964BD7D19CCC0),  # noqa: E501
    )
