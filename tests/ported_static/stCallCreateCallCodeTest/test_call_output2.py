...
Ported from:
tests/static/state_tests/stCallCreateCallCodeTest/callOutput2Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCreateCallCodeTest/callOutput2Filler.json",  # noqa: E501
    ],
)
...
def test_call_output2(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x7eceed6f6dd8b5ed0637dc20761945256e2bafc7"),  # noqa: E501
    )
    # Source: raw bytecode
