...
Ported from:
tests/static/state_tests/stSStoreTest/sstore_XtoYto0Filler.json
"""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "6000601580603860003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f1500000fe600160005560026000556000600055600160015500",  # noqa: E501
            1000000,
            {
                Address("0x96606e69ee07f3ba565d1f25edea6c691a780e71"): Account(
                    storage={1: 1}
                ),
                Address("0xb000000000000000000000000000000000000000"): Account(
                    storage={1: 1}
        ...
        (
            "6000601580603d60003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f15060206000fd0000fe600160005560026000556000600055600160015500",  # noqa: E501
            1000000,
            {
                Address("0xb000000000000000000000000000000000000000"): Account(
                    storage={1: 1}
