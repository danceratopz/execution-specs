...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stSystemOperationsTest/CallToNameRegistratorNotMuchMemory1Filler.json",  # noqa: E501
    ],
)
...
def test_call_to_name_registrator_not_much_memory1(
    ...
    # Source: LLL
    # { (MSTORE 0 0xeeffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff00) (MSTORE 32 0xaaffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffaa ) [[ 0 ]] (CALL 500 <contract:0x945304eb96065b2a98b57a48a06ae28d285a71b5> 23 987654 0 64 0) }  # noqa: E501
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x8e2af1ed48cb5567a2bc09cde959dc7b5e5557ba"),  # noqa: E501
    )
