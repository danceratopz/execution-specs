...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest527Filler.json
"""
...
def test_random_statetest527(
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "347f000000000000000000000000ffffffffffffffffffffffffffffffffffffffff447f"  # noqa: E501
            ...
            "ffffffffffffffffffffffffffffffffffffffff80a1"
        ),
        gas_limit=100000,
        value=179309326,
    )
