...
@pytest.mark.ported_from(
    [
        "state_tests/stCallCodes/callcallcodecallcode_011_SuicideMiddleFiller.json"  # noqa: E501
    ],
)
...
def test_callcallcodecallcode_011_suicide_middle(
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xD5AE5241BA19BEBFDE24D3BD723C61CF8185F140),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALL(
                gas=0x249F0,
                address=0x0E6FF095F71C846D075130C292826190F698DC08,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0x941B4E51166FA7D2405B76C44BC897D24DC4E3CF),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0x186A0,
                address=0x58DED445D89963DFB8668B9A16B24AFA6F9B83A8,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x0E6FF095F71C846D075130C292826190F698DC08),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.SELFDESTRUCT(
            address=0x941B4E51166FA7D2405B76C44BC897D24DC4E3CF
        )
        + Op.SSTORE(
            key=0x2,
            value=Op.CALLCODE(
                gas=0xC350,
                address=0xD5AE5241BA19BEBFDE24D3BD723C61CF8185F140,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
