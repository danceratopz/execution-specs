...
def test_random_statetest625(
    ...
    """Test_random_statetest625."""
    coinbase = Address(0x2379296AE60F3729A245BD706548942FA0A3A750)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x2379296AE60F3729A245BD706548942FA0A3A750),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=100000,
        value=0x607918DC,
    )
