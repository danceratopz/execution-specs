...
def test_random_statetest626(
    ...
    """Test_random_statetest626."""
    coinbase = Address(0xB64FDC6728EE8E386F2701877ED3EA20BF39CC91)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xB64FDC6728EE8E386F2701877ED3EA20BF39CC91),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.REVERT(
            offset=Op.DELEGATECALL(
                ...
                address=Op.PUSH32[0xB64FDC6728EE8E386F2701877ED3EA20BF39CC91],
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=100000,
        value=0x7700577A,
    )
