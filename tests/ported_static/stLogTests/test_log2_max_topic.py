...
Ported from:
tests/static/state_tests/stLogTests/log2_MaxTopicFiller.json
"""
...
def test_log2_max_topic(
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0x3E8,
                    address=0x317504258A7AACAC178DA9B86E047C40C8A0A15B,
                    value=0x17,
                    args_offset=0x0,
                    args_size=0x0,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address("0x317504258a7aacac178da9b86e047c40c8a0a15b"),  # noqa: E501
    )
