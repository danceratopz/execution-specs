...
Ported from:
tests/static/state_tests/stRandom/randomStatetest31Filler.json
"""
...
def test_random_statetest31(
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "387f00000000000000000000000100000000000000000000000000000000000000007f00"  # noqa: E501
            ...
            "000000000000000000000000000000009037"
        ),
        gas_limit=100000,
        value=1344810912,
    )
