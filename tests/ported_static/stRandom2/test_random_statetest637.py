...
def test_random_statetest637(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x44931064138E9DF1768334028C201471,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffff6f44931064138e9df1768334028c20"  # noqa: E501
            "1471"
        ),
        gas_limit=100000,
        value=1479766116,
    ...
    post = {
        contract: Account(storage={0: 0x44931064138E9DF1768334028C201471}),
    }
