...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stZeroKnowledge/ecpairing_two_points_with_one_g2_zeroFiller.json",  # noqa: E501
    ],
)
...
def test_ecpairing_two_points_with_one_g2_zero(
    ...
    pre[coinbase] = Account(balance=0x1E5F0C, nonce=0)
    ...
    pre[sender] = Account(balance=0xDE0B6B3A745A0F4, nonce=10)
