...
Ported from:
tests/static/state_tests/stStaticCall/static_CallSha256_3_postfix0Filler.json
"""
...
def test_static_call_sha256_3_postfix0(
    ...
    # Source: LLL
    # { (MSTORE 0 0xf34578907f00) [[ 2 ]] (STATICCALL 500 2 0 37 0 32) [[ 0 ]] (MLOAD 0)}  # noqa: E501
    contract = pre.deploy_contract(
        ...
        balance=0x1312D00,
        nonce=0,
        address=Address("0xd147fce2c6650060e058b25ccfd3c7b24d744503"),  # noqa: E501
    )
