...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesHomestead/callcallcode_01_OOGEFiller.json",  # noqa: E501
    ],
)
...
def test_callcallcode_01_ooge(
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0xC3500,
                    address=0x42473C2734EB62B91E4E2AC3DAB63AB2443F4236,
                    value=0x0,
                    args_offset=0x0,
                    args_size=0x40,
                    ret_offset=0x0,
    ...
    callee = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x42473c2734eb62b91e4e2ac3dab63ab2443f4236"),  # noqa: E501
    )
    pre.deploy_contract(
        code=(
