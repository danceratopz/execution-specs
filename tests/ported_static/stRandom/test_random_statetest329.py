...
Ported from:
tests/static/state_tests/stRandom/randomStatetest329Filler.json
"""
...
def test_random_statetest329(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0xA48D775458574133769C8B750207FF55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffff426fa48d775458574133769c8b750207ff"
        ),
        gas_limit=100000,
        value=1532627820,
    )
    ...
    post = {
        contract: Account(storage={0: 0xA48D775458574133769C8B750207FF55}),
    }
