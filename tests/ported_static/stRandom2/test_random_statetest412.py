...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest412Filler.json
"""
...
def test_random_statetest412(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0xA46EF06A5A858B9742198A37E1153C55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffff6fa46ef06a5a858b9742198a37e1153c"
        ),
        gas_limit=100000,
        value=123532973,
    )
    ...
    post = {
        contract: Account(storage={0: 0xA46EF06A5A858B9742198A37E1153C55}),
    }
