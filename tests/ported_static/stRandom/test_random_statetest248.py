...
Ported from:
tests/static/state_tests/stRandom/randomStatetest248Filler.json
"""
...
def test_random_statetest248(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x6131276e33583c2356c9ac9b9eb5eec9999ef591"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000001427f00000000000000000000"  # noqa: E501
            ...
            "ffffffffffffffffffffffffffffffff8636f25990"
        ),
        gas_limit=100000,
        value=549769638,
    )
    ...
    post = {
        contract: Account(storage={0: 50016}),
    }
