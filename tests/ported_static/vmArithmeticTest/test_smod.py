...
def test_smod(
    ...
    #    [[0]] (smod 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff 2)  # noqa: E501
    # }
    ...
    # {
    #    ; 0 % -1
    #    [[0]] (smod 0 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff)  # noqa: E501
    # }
    ...
    contract_4 = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(key=0x0, value=Op.SMOD(Op.SUB(0x0, 0x2), 0x3))
        + Op.STOP,
        balance=0xBA1A9CE0BA1A9CE,
        nonce=0,
    ...
    contract_5 = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(key=0x0, value=Op.SUB(Op.SMOD(0x10, 0x0), 0x1))
        + Op.STOP,
        balance=0xBA1A9CE0BA1A9CE,
        nonce=0,
