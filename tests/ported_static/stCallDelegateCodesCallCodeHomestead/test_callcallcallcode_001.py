...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallDelegateCodesCallCodeHomestead/callcallcallcode_001Filler.json",  # noqa: E501
    ],
)
        ...
        code=(
            Op.SSTORE(
                ...
                value=Op.DELEGATECALL(
                    gas=0x3D090,
                    address=0xC534813374D4D5C43DD9A367926A3DBEECD02964,
                    args_offset=0x0,
                    args_size=0x40,
                    ret_offset=0x0,
                    ret_size=0x40,
