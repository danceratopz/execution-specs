...
Ported from:
tests/static/state_tests/stRandom/randomStatetest237Filler.json
"""
...
def test_random_statetest237(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000000000000000001537f00000000"  # noqa: E501
            ...
            "000000000000000000000000000000003938"
        ),
        gas_limit=100000,
        value=978542004,
    )
