...
def test_random_statetest440(
    ...
    """Test_random_statetest440."""
    coinbase = Address(0x4E4779425850C2FA60141D9B3FF35D9E7DEB935C)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x4E4779425850C2FA60141D9B3FF35D9E7DEB935C),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x4E4779425850C2FA60141D9B3FF35D9E7DEB935C]
        + Op.GASLIMIT * 2
        + Op.PUSH32[0x1] * 2
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x4A3FD736,
    )
