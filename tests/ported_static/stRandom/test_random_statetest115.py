...
Ported from:
tests/static/state_tests/stRandom/randomStatetest115Filler.json
"""
...
def test_random_statetest115(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x15448E363302150A6F56518AA0053155,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000c3506f15448e363302150a6f56518aa00531"
        ),
        gas_limit=3202574,
        value=1948713091,
    )
    ...
    post = {
        contract: Account(storage={0: 0x15448E363302150A6F56518AA0053155}),
    }
