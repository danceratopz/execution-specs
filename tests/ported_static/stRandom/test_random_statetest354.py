...
def test_random_statetest354(
    ...
    """Test_random_statetest354."""
    coinbase = Address(0xBFEA108CF96EE6537817C1FE8A815E14CD6A645D)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xBFEA108CF96EE6537817C1FE8A815E14CD6A645D),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xBFEA108CF96EE6537817C1FE8A815E14CD6A645D]
        + Op.PUSH32[
        ...
        + Op.SSTORE,
        nonce=0,
        address=Address(0xF5128D151D2B28EAB17B340C1BD00E96683B90D6),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x24AAAAF6,
    )
