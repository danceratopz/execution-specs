...
def test_random_statetest15(
    ...
    """Test_random_statetest15."""
    coinbase = Address(0xDC92C32D3904F19BE512498FC2E955CE5C6CCB48)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xDC92C32D3904F19BE512498FC2E955CE5C6CCB48),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xDC92C32D3904F19BE512498FC2E955CE5C6CCB48]
        + Op.PUSH32[0x0]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x598426AC,
    )
