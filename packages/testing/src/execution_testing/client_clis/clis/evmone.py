...
class EvmoneExceptionMapper(ExceptionMapper):
    ...
    mapping_substring: ClassVar[Dict[ExceptionBase, str]] = {
        ...
        EOFException.MAX_STACK_INCREASE_ABOVE_LIMIT: (
            "err: max_stack_increase_above_limit"
        ),
        EOFException.STACK_HIGHER_THAN_OUTPUTS: (
            "err: stack_higher_than_outputs_required"
        ),
        ...
        EOFException.INVALID_MAX_STACK_INCREASE: (
            "err: invalid_max_stack_increase"
        ),
        ...
        EOFException.INVALID_CODE_SECTION_INDEX: (
            "err: invalid_code_section_index"
        ),
        EOFException.CALLF_TO_NON_RETURNING: (
