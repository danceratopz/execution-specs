...
Ported from:
tests/static/state_tests/stRandom/randomStatetest194Filler.json
"""
...
def test_random_statetest194(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xd53f0ec62568cdbc447c9967c97db408d33ece9a"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffff097f0000000000000000000000004f3f7014"  # noqa: E501
