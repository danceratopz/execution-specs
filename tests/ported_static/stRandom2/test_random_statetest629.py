...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest629Filler.json
"""
...
def test_random_statetest629(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x427277147C617F4354A35A1A47977A55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "004f3f701464972e74606d6ea82d4d3080599a0e79347f0000000000000000000000004f"  # noqa: E501
            "3f701464972e74606d6ea82d4d3080599a0e79116f427277147c617f4354a35a1a47977a"  # noqa: E501
        ),
        gas_limit=100000,
        value=1003338368,
    )
    ...
    post = {
        contract: Account(storage={0: 0x427277147C617F4354A35A1A47977A55}),
    }
