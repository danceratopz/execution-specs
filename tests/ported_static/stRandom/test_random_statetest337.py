...
Ported from:
tests/static/state_tests/stRandom/randomStatetest337Filler.json
"""
...
def test_random_statetest337(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xc91de65c756caaa7d9edbc50ac7494254a4e2cf6"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000c350670b9af27e9a6468a1"
        ),
        gas_limit=100000,
        value=333069461,
    )
    ...
    post = {
        contract: Account(storage={0: 50000, 0xB9AF27E9A6468A1: 50000}),
    }
