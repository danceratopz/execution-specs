...
Ported from:
tests/static/state_tests/stRandom/randomStatetest318Filler.json
"""
...
def test_random_statetest318(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x8206A30A83887E5A3164667796308D55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000000000000000c350457f00000000"  # noqa: E501
            ...
            "0000000000000000000000000000c3506f8206a30a83887e5a3164667796308d"
        ),
        gas_limit=100000,
        value=603571959,
    )
    ...
    post = {
        contract: Account(storage={0: 0x8206A30A83887E5A3164667796308D55}),
    }
