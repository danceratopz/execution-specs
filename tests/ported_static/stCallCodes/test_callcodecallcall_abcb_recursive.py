...
Ported from:
state_tests/stCallCodes/callcodecallcall_ABCB_RECURSIVEFiller.json
"""
...
def test_callcodecallcall_abcb_recursive(
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0x17D7840,
                address=0x1A3A06ED7E0ECD4479E333954EC159CD1EB0CE9F,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0x56B6CB45E9444B9DE6F7FFDB97D545957071BEE6),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALL(
                gas=0xF4240,
                address=0xAF68323D77444116938704B8B877069F2A26CAB1,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x1A3A06ED7E0ECD4479E333954EC159CD1EB0CE9F),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xAF68323D77444116938704B8B877069F2A26CAB1),  # noqa: E501
    )
