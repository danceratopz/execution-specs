...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest471Filler.json
"""
...
def test_random_statetest471(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "fffffffffffffffffffffffe09650618701355040655183a51377d8260005155"
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffff7f0000000000000000000000010000000000"  # noqa: E501
            "0000000000000000000000000000007fffffffffffffffffffffffffffffffffffffffff"  # noqa: E501
            "fffffffffffffffffffffffe09650618701355040655183a51377d82"
        ),
        gas_limit=100000,
        value=1662521271,
    )
