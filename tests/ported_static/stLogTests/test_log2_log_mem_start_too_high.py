...
Ported from:
tests/static/state_tests/stLogTests/log2_logMemStartTooHighFiller.json
"""
...
def test_log2_log_mem_start_too_high(
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0x3E8,
                    address=0x9C6A28DAEC9E2AF2FA5C362EEDC028ACD207E63B,
                    value=0x17,
                    args_offset=0x0,
                    args_size=0x0,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address("0x9c6a28daec9e2af2fa5c362eedc028acd207e63b"),  # noqa: E501
    )
