...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stZeroKnowledge/ecpairing_three_point_match_1Filler.json",  # noqa: E501
    ],
)
...
def test_ecpairing_three_point_match_1(
    ...
    pre[coinbase] = Account(balance=0x42F15B, nonce=0)
    ...
    pre[sender] = Account(balance=0xDE0B6B3A7210EA5, nonce=18)
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0cd3d66530f74dc94c94adb88f5cdb481acca997b6e60071f08a115f2f997f3dbd66a7af"  # noqa: E501
            "e07fe7862ce239edba9e05c5afff7f8a1259c9733b2dfbb929d1691530ca701b4a106054"  # noqa: E501
            "688728c9972c8512e9789e9567aae23e302ccd7500000000000000000000000000000000"  # noqa: E501
            "000000000000000000000000000000010000000000000000000000000000000000000000"  # noqa: E501
            "000000000000000000000002000000000000000000000000000000000000000000000000"  # noqa: E501
