...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stStaticCall/static_callcallcall_000_OOGMBeforeFiller.json",  # noqa: E501
    ],
)
...
def test_static_callcallcall_000_oogm_before(
    ...
    # Source: LLL
    # {  [[ 0 ]] (STATICCALL 600000 <contract:0x1000000000000000000000000000000000000001> 0 64 0 64 ) [[ 1 ]] 1 }  # noqa: E501
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.STATICCALL(
                    gas=0x927C0,
                    address=0xEDBFA645E2C5462398C0BD3A12E41EF8EC1F9F5,
                    args_offset=0x0,
                    args_size=0x40,
                    ret_offset=0x0,
                    ret_size=0x40,
    ...
    pre.deploy_contract(
        code=(
            Op.STATICCALL(
                gas=0x61AD0,
                address=0x97498B4CE896BE02417BCFE036BEAC3332185563,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
