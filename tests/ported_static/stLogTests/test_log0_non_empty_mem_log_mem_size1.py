...
Ported from:
tests/static/state_tests/stLogTests/log0_nonEmptyMem_logMemSize1Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stLogTests/log0_nonEmptyMem_logMemSize1Filler.json",  # noqa: E501
    ],
)
