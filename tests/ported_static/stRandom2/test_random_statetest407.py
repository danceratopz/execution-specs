...
def test_random_statetest407(
    ...
    """Test_random_statetest407."""
    coinbase = Address(0xB9BBCF473A4A891E269112BC171F9D0D523838D3)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xB9BBCF473A4A891E269112BC171F9D0D523838D3),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        * 2
        ...
        + Op.NUMBER
        + Op.PUSH32[0x0]
        + Op.PUSH32[0xB9BBCF473A4A891E269112BC171F9D0D523838D3]
        + Op.SSTORE(
            key=Op.MLOAD(offset=0x0), value=0x6D71656F054471181163037902615B55
        ),
        nonce=0,
        address=Address(0x819EE19601AD27EDAEEEAD744E0BBF165FDFB9F1),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x313547F8,
    )
