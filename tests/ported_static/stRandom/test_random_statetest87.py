...
def test_random_statetest87(
    ...
    """Test_random_statetest87."""
    coinbase = Address(0x3D499EED77B408EB3FB03874A19170009ED65CA9)
    sender = EOA(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.SSTORE(
            key=Op.MLOAD(offset=0x0), value=0x446E638E7E16736C030393727D748174
        ),
        nonce=0,
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x3D499EED77B408EB3FB03874A19170009ED65CA9),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x7B1E5DC9,
    )
