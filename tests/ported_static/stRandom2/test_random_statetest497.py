...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest497Filler.json
"""
...
def test_random_statetest497(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xfcd27debf054614355478e0ff6c51d24676987c6"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffff0904"
        ),
        gas_limit=100000,
        value=1143211377,
    )
