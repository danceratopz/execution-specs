"""
Test_static_callcallcallcode_001_oogm_after.

Ported from:
state_tests/stStaticCall/static_callcallcallcode_001_OOGMAfterFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticCall/static_callcallcallcode_001_OOGMAfterFiller.json"  # noqa: E501
    ],
)
...
def test_static_callcallcallcode_001_oogm_after(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x53CD82FE89033888402417ABEC4CCB39334F31E7),  # noqa: E501
    )
    # Source: lll
    # {  (MSTORE 3 1) }
    addr_4 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x08B57C504015ED3AE602B27CBD65643F8CDE2129),  # noqa: E501
    )
    # Source: lll
    # {  (MSTORE 3 1) (DELEGATECALL 120020 <contract:0x1000000000000000000000000000000000000003> 0 64 0 64 ) (MSTORE 32 1) }  # noqa: E501
    addr_3 = pre.deploy_contract(  # noqa: F841
        code=Op.MSTORE(offset=0x3, value=0x1)
        + Op.POP(
            Op.DELEGATECALL(
                gas=0x1D4D4,
                address=0x08B57C504015ED3AE602B27CBD65643F8CDE2129,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
    ...
    post = {
        ...
        addr_4: Account(storage={1: 0, 2: 0, 3: 0}),
