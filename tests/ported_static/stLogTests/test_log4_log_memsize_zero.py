...
Ported from:
tests/static/state_tests/stLogTests/log4_logMemsizeZeroFiller.json
"""
...
def test_log4_log_memsize_zero(
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0x3E8,
                    address=0xB03FD6E714A14074A17E2ECFD412E35B1DDB21E5,
                    value=0x17,
                    args_offset=0x0,
                    args_size=0x0,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address("0xb03fd6e714a14074a17e2ecfd412e35b1ddb21e5"),  # noqa: E501
    )
