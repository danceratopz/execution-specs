...
Ported from:
tests/static/state_tests/stRandom/randomStatetest220Filler.json
"""
...
def test_random_statetest220(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x420380A03C4282A3540A1A333A843A55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000000000016f420380a03c4282a3540a1a333a843a"  # noqa: E501
        ),
        gas_limit=100000,
        value=207355039,
    )
    ...
    post = {
        contract: Account(storage={0: 0x420380A03C4282A3540A1A333A843A55}),
    }
