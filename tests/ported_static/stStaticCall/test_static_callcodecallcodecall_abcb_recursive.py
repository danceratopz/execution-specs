...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticCall/static_callcodecallcodecall_ABCB_RECURSIVEFiller.json"  # noqa: E501
    ],
)
...
def test_static_callcodecallcodecall_abcb_recursive(
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.DELEGATECALL(
                gas=0x17D7840,
                address=0x1AFC9445182A89E5857C45F6B82A7A06C1BA7B74,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        nonce=0,
        address=Address(0xF05C37C1D69C5FBCD7221B01771D0F294C50D40B),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.DELEGATECALL(
            gas=0xF4240,
            address=0x588AC17C8FE0BD5C7604A41971351EA049AC7994,
            args_offset=0x0,
            args_size=0x40,
            ret_offset=0x0,
            ret_size=0x40,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x1AFC9445182A89E5857C45F6B82A7A06C1BA7B74),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x588AC17C8FE0BD5C7604A41971351EA049AC7994),  # noqa: E501
    )
