...
def test_random_statetest399(
    ...
    """Test_random_statetest399."""
    coinbase = Address(0x0BBA139E91EA802B9142AB8FE5661611C3D4600C)
    sender = EOA(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0xADC7243877FC6DD362B874238D7E02ABD01D15C7),  # noqa: E501
    )
    # Source: raw
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x0BBA139E91EA802B9142AB8FE5661611C3D4600C),  # noqa: E501
    )
