...
Ported from:
tests/static/state_tests/stRandom/randomStatetest39Filler.json
"""
...
def test_random_statetest39(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffffffffffffffff427f00000000000000"  # noqa: E501
            ...
            "fffffffffffffffffffffffffffffffe9604638ea2179a5803"
        ),
        gas_limit=100000,
        value=272686139,
    )
