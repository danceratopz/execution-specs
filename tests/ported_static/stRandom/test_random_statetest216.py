...
def test_random_statetest216(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x766D67FE07853208991306449455,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000000000c350447f00000000000000"  # noqa: E501
    ...
    post = {
        contract: Account(storage={0: 0x766D67FE07853208991306449455}),
    }
