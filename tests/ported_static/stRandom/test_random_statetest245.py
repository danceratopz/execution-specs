...
def test_random_statetest245(
    ...
    """Test_random_statetest245."""
    coinbase = Address(0x8FA4049F6B51C3B4855E1CFDD3B59B03BE92C12B)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x8FA4049F6B51C3B4855E1CFDD3B59B03BE92C12B),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PUSH32[0x8FA4049F6B51C3B4855E1CFDD3B59B03BE92C12B]
        + Op.ISZERO(
            0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
        )
        + Op.PUSH32[0x0]
        + Op.PUSH32[0x8FA4049F6B51C3B4855E1CFDD3B59B03BE92C12B]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
