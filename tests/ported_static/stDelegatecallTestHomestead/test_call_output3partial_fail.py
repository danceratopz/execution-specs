...
Ported from:
state_tests/stDelegatecallTestHomestead/callOutput3partialFailFiller.json
"""
...
def test_call_output3partial_fail(
    ...
    addr = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x0C8FB51293F19C5C242AD9F0301A96E8E23A66A4),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address(0x7D77ADFD300BED12F6FF1C48BFB5F706ECC129DA),  # noqa: E501
    )
