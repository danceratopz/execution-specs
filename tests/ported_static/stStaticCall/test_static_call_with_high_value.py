...
Ported from:
tests/static/state_tests/stStaticCall/static_callWithHighValueFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stStaticCall/static_callWithHighValueFiller.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Byzantium")
@pytest.mark.pre_alloc_mutable
@pytest.mark.slow
def test_static_call_with_high_value(
