...
Ported from:
tests/static/state_tests/stRandom/randomStatetest301Filler.json
"""
...
def test_random_statetest301(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SWAP5
            + Op.SSTORE(
                key=Op.MLOAD(offset=0x0), value=0x737AA092F1975664518A55
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000003784946a737aa092f1975664518a"
        ),
        gas_limit=100000,
        value=323025358,
    )
