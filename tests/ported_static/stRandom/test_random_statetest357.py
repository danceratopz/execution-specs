...
Ported from:
tests/static/state_tests/stRandom/randomStatetest357Filler.json
"""
...
def test_random_statetest357(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000c350427fffffffffffffffffffff"  # noqa: E501
            ...
            "ffffffffffffffffffffffffffffffff09377c5380715560005155"
        ),
        nonce=0,
        address=Address("0x625c4c0c1932d06a13b656f82b55acaf57689dda"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffffffffffff7fffffffffffffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffffffffffff7fffffffffffffffffffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffffff09377c538071"
        ),
        gas_limit=100000,
        value=1516457170,
    )
