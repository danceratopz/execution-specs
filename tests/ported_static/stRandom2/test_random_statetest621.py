...
def test_random_statetest621(
    ...
    """Test_random_statetest621."""
    coinbase = Address(0xBF8B114BCE3E20AED583489BBDC79B9E2E3F2155)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xBF8B114BCE3E20AED583489BBDC79B9E2E3F2155),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xBF8B114BCE3E20AED583489BBDC79B9E2E3F2155] * 2
        ...
        nonce=0,
        address=Address(0x3E00AB7141473834E4482F5650561879FEEB3E7B),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x7FC94217,
    )
