...
def pytest_addoption(parser: pytest.Parser) -> None:
    ...
    help_group.addoption(
        ...
        default=False,
        help=(
            "Show help options only for the "
            "check_eip_versions command and exit."
        ),
    )
    help_group.addoption(
        "--fill-help",
    ...
    help_group.addoption(
        ...
        default=False,
        help=(
            "Show help options specific to the "
            "execute remote command and exit."
        ),
    )
    help_group.addoption(
        "--execute-hive-help",
    ...
    help_group.addoption(
        ...
        help=(
            "Show help options specific to the "
            "execute recover command and exit."
        ),
    )
    help_group.addoption(
        ...
        help=(
            "Show help options specific to the "
            "execute eth_config command and exit."
        ),
    )
...
def show_specific_help(
    ...
    if pytest_ini.name != expected_ini:
        raise ValueError(
            f"Unexpected {expected_ini}!={pytest_ini.name} "
            "file option generating help."
        )
