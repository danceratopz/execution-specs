...
def test_callcallcallcode_001_suicide_middle(
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xF5D97E3405D7A9829347A295605169DE5483577F),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0x249F0,
                address=0x52A16851167C838833FD8D609F364F86AE694BDC,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0x54125CA20F0A12F998F8D6D8B14198C49C284B0B),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0x186A0,
                address=0x6F8ADC2F90F976047961E8E6250325F790F220F3,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x52A16851167C838833FD8D609F364F86AE694BDC),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.SELFDESTRUCT(
            address=0x54125CA20F0A12F998F8D6D8B14198C49C284B0B
        )
        + Op.SSTORE(
            key=0x2,
            value=Op.DELEGATECALL(
                gas=0xC350,
                address=0xF5D97E3405D7A9829347A295605169DE5483577F,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x6F8ADC2F90F976047961E8E6250325F790F220F3),  # noqa: E501
    )
    ...
    post = {
        ...
        addr: Account(storage={1: 0, 2: 0}, balance=0x2540BE400),
        addr_2: Account(storage={0: 0, 2: 0}, balance=0x2540BE400),
