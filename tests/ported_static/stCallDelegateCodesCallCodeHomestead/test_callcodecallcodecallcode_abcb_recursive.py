...
@pytest.mark.ported_from(
    [
        "state_tests/stCallDelegateCodesCallCodeHomestead/callcodecallcodecallcode_ABCB_RECURSIVEFiller.json"  # noqa: E501
    ],
)
...
def test_callcodecallcodecallcode_abcb_recursive(
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.DELEGATECALL(
                gas=0x17D7840,
                address=0x705CDF47A5D044E538AB0F75CEB47A772114A8FC,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        nonce=0,
        address=Address(0xC2BBA4B0DA8764316C7682A948DFCF57D35CEC8E),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.DELEGATECALL(
                gas=0xF4240,
                address=0x22EB47AE84DB812A07A7CBBD29CAB72FF2F55C6F,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x705CDF47A5D044E538AB0F75CEB47A772114A8FC),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x22EB47AE84DB812A07A7CBBD29CAB72FF2F55C6F),  # noqa: E501
    )
