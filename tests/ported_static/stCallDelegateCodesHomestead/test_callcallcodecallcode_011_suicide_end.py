...
Ported from:
state_tests/stCallDelegateCodesHomestead/callcallcodecallcode_011_SuicideEndFiller.json
...
def test_callcallcodecallcode_011_suicide_end(
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x34F0E18BE1364384D79AEBAB7BB7B91C17C3D415),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            key=0x0,
            value=Op.CALL(
                address=0x13244A830D4E9135F2B6EBE2F9832A50A824D21A,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0xE93436ED63ABEE0588A5B001C49648725EF531FD),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.DELEGATECALL(
                address=0x655655F48C097C318315DB67C9A8B04E5617C3B6,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x13244A830D4E9135F2B6EBE2F9832A50A824D21A),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            key=0x2,
            value=Op.DELEGATECALL(
                address=0x34F0E18BE1364384D79AEBAB7BB7B91C17C3D415,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        + Op.SELFDESTRUCT(address=0x13244A830D4E9135F2B6EBE2F9832A50A824D21A)
        + Op.STOP,
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x655655F48C097C318315DB67C9A8B04E5617C3B6),  # noqa: E501
    )
    ...
    post = {
        ...
        addr: Account(storage={1: 1, 2: 1, 3: 1}, balance=0x2540BE400),
