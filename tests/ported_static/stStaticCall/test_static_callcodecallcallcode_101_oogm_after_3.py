...
def test_static_callcodecallcallcode_101_oogm_after_3(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x8518F26D39E693B82353BEE54737BE743B5E6693),  # noqa: E501
    )
    # Source: lll
    # {  (MSTORE 3 1) }
    addr_4 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x355C393A912399CB192F7F221369BFBAAD10D4EE),  # noqa: E501
    )
    # Source: lll
    # {  (SSTORE 3 1) }
    addr_8 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x872DE0742C241DB2B47D6292B90616E2C96CF89F),  # noqa: E501
    )
    # Source: lll
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        code=Op.POP(
            Op.DELEGATECALL(
                gas=0x4E34,
                address=0x355C393A912399CB192F7F221369BFBAAD10D4EE,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
    ...
    addr_7 = pre.deploy_contract(  # noqa: F841
        code=Op.POP(
            Op.DELEGATECALL(
                gas=0x4E34,
                address=0x872DE0742C241DB2B47D6292B90616E2C96CF89F,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
