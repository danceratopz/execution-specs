...
That flag is worth the note it takes to explain, because the alternative
is expensive. This module once carried its own sponge in Python, on the
belief that no available implementation allowed a digest mid-stream. It
absorbed around 0.2 MiB/s, so MAC-ing one frame of an eight mebibyte
EIP-7934 block took the best part of a minute - long enough for a
syncing client to give up on the peer and drop it mid-transfer.
"""
