...
Ported from:
tests/static/state_tests/stLogTests/log4_logMemStartTooHighFiller.json
"""
...
def test_log4_log_mem_start_too_high(
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0x3E8,
                    address=0x57D85807540DA11B345D5909E74550D27E116302,
                    value=0x17,
                    args_offset=0x0,
                    args_size=0x0,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address("0x57d85807540da11b345d5909e74550d27e116302"),  # noqa: E501
    )
