...
def test_random_statetest542(
    ...
    """Test_random_statetest542."""
    coinbase = Address(0xE61475265E22FAD4B6D9A00FE4AEA19B6323691B)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xE61475265E22FAD4B6D9A00FE4AEA19B6323691B),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xE61475265E22FAD4B6D9A00FE4AEA19B6323691B]
        + Op.SWAP3
        + Op.SSTORE
        + Op.MLOAD(offset=0x0)
        + Op.SSTORE,
        nonce=0,
        address=Address(0x0173C63BEF6FF158E671BD806EDE19A25095E723),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
