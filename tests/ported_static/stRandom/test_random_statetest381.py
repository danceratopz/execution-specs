...
def test_random_statetest381(
    ...
    """Test_random_statetest381."""
    coinbase = Address(0xFF5867F268CCDF362757BED9061CADB18713CAD1)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xFF5867F268CCDF362757BED9061CADB18713CAD1),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.COINBASE
        + Op.PUSH32[0x0]
        + Op.PUSH32[0xFF5867F268CCDF362757BED9061CADB18713CAD1] * 2
        + Op.PUSH32[0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF]
        + Op.SSTORE(
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x2D1A0F83,
    )
