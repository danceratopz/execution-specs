...
Ported from:
tests/static/state_tests/stRandom/randomStatetest43Filler.json
"""
...
def test_random_statetest43(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x32dddb92acb638eede178ae680d1c7362bd89fd5"),  # noqa: E501
    )
    # Source: raw bytecode
    pre.deploy_contract(
        code=(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "972e74606d6ea82d4d3080599a0e797fffffffffffffffffffffffffffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffff3b0a55096941861a3755a196f259a1"
        ),
        gas_limit=100000,
        value=580684794,
    )
