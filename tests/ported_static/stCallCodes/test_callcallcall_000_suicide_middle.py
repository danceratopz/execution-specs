"""
call -> call -> suicide, call -> code.

Ported from:
tests/static/state_tests/stCallCodes/callcallcall_000_SuicideMiddleFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCodes/callcallcall_000_SuicideMiddleFiller.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Byzantium")
@pytest.mark.pre_alloc_mutable
def test_callcallcall_000_suicide_middle(
    ...
    callee_1 = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0x186A0,
                    address=0xBA5A575C914981FB64BFB082DC59434C66EB2714,
                    value=0x0,
                    args_offset=0x0,
                    args_size=0x40,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address("0xba5a575c914981fb64bfb082dc59434c66eb2714"),  # noqa: E501
    )
