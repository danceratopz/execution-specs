...
Ported from:
state_tests/stCallCodes/callcodecallcodecall_ABCB_RECURSIVEFiller.json
"""
...
def test_callcodecallcodecall_abcb_recursive(
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0x17D7840,
                address=0xBDD6B53D42BF13A6C3C6BB8A5EF7B6688BC7F3BF,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0x769FFB568D903D41EEFECD9FBCFF567F9243DEB8),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0xF4240,
                address=0xE5DA8ABDB2A2950C9F744BCDC776060472CF08CD,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xBDD6B53D42BF13A6C3C6BB8A5EF7B6688BC7F3BF),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xE5DA8ABDB2A2950C9F744BCDC776060472CF08CD),  # noqa: E501
    )
