...
def test_random_statetest88(
    ...
    """Test_random_statetest88."""
    coinbase = Address(0x2A6DBD2C638B9386862E8D84A54BA060EEE4D248)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x2A6DBD2C638B9386862E8D84A54BA060EEE4D248),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PUSH32[0x2A6DBD2C638B9386862E8D84A54BA060EEE4D248]
        ...
        nonce=0,
        address=Address(0x4150A4F366C525B471E788D777BFD0D118CE5B23),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x3E996CB5,
    )
