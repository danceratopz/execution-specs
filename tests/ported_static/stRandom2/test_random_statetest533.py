...
def test_random_statetest533(
    ...
    """Test_random_statetest533."""
    coinbase = Address(0x955FF91835F3264ACA81E1099637F1EB3ACC25A0)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x955FF91835F3264ACA81E1099637F1EB3ACC25A0),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x955FF91835F3264ACA81E1099637F1EB3ACC25A0]
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x70D690F4,
    )

    post = {
        target: Account(storage={0: 21077}, nonce=0),
