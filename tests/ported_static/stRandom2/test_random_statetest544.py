...
def test_random_statetest544(
    ...
    """Test_random_statetest544."""
    coinbase = Address(0x99A0A6AE56434EC06F4D6F9F1DA943EF53065DE0)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x99A0A6AE56434EC06F4D6F9F1DA943EF53065DE0),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x505C017E,
    )
