...
def test_random_statetest216(
    ...
    """Test_random_statetest216."""
    coinbase = Address(0xD78770E75BFCECB5D900F11E66B64562FDA38280)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xD78770E75BFCECB5D900F11E66B64562FDA38280),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xC350] * 2
        + Op.PREVRANDAO
        + Op.PUSH32[0xD78770E75BFCECB5D900F11E66B64562FDA38280]
        + Op.PUSH32[0xC350]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x288181DD,
    )
