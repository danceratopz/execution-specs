...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest503Filler.json
"""
...
def test_random_statetest503(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x886A83C66553C9889528D8F1294FF55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0100000000000000000000000000000000000000007fffffffffffffffffffffffffffff"  # noqa: E501
            ...
            "0000000000000000000000006f0886a83c66553c9889528d8f1294ff"
        ),
        gas_limit=100000,
        value=2071462314,
    )
    ...
    post = {
        contract: Account(storage={0: 0x886A83C66553C9889528D8F1294FF55}),
    }
