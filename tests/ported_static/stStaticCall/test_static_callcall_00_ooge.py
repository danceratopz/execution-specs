...
def test_static_callcall_00_ooge(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0xC31B8312C42A80184AF42E37142AF32EFB67C7D5),  # noqa: E501
    )
    # Source: lll
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0x6FDBA6FA241531A3253F188F6615C9C36C0DFC55),  # noqa: E501
    )
    # Source: lll
    ...
    # Source: lll
    # { (MSTORE 2 1) (STATICCALL 120020 <contract:0x1000000000000000000000000000000000000002> 0 64 0 64 ) (MSTORE 32 1)  }  # noqa: E501
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.MSTORE(offset=0x2, value=0x1)
        + Op.POP(
            Op.STATICCALL(
                gas=0x1D4D4,
                address=0x6FDBA6FA241531A3253F188F6615C9C36C0DFC55,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
    ...
    # Source: lll
    # {  (MSTORE 2 1) (STATICCALL 20020 <contract:0x2000000000000000000000000000000000000002> 0 64 0 64 ) (MSTORE 32 1) }  # noqa: E501
    ...
    addr = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x06D2AEBA0F11FFDAD4CE1A36659A5019E523237F),  # noqa: E501
    )
    # Source: lll
    ...
    addr_4 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address(0x70C0A71DD076810AB6ACBED25BF031AC91300377),  # noqa: E501
    )
    ...
    expect_entries_: list[dict] = [
        {
            ...
            "network": [">=Cancun"],
            "result": {
                addr: Account(storage={0: 1, 1: 0, 2: 0}),
                addr_2: Account(storage={1: 0, 2: 0}),
                addr_3: Account(storage={2: 0}),
        ...
        },
        {
            ...
            "network": [">=Cancun"],
            "result": {
                addr_4: Account(storage={0: 1, 1: 0, 2: 0}),
                addr_5: Account(storage={1: 0, 2: 0}),
                addr_6: Account(storage={2: 0}),
                target: Account(storage={0: 1, 1: 1}),
            },
        },
    ]
