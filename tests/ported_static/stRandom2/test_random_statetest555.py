"""
Test_random_statetest555.

Ported from:
state_tests/stRandom2/randomStatetest555Filler.json
...
def test_random_statetest555(
    ...
    """Test_random_statetest555."""
    coinbase = Address(0x0B7FAB72E9B46E78BF15643681EE61F77ED7270F)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x0B7FAB72E9B46E78BF15643681EE61F77ED7270F),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PUSH32[0x0B7FAB72E9B46E78BF15643681EE61F77ED7270F]
        + Op.PUSH32[0xC350]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x719DE78,
    )
