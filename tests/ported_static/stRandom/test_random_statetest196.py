...
def test_random_statetest196(
    ...
    """Test_random_statetest196."""
    coinbase = Address(0x99D4F9EA872CE02274990B253120A1C6200C73D5)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x99D4F9EA872CE02274990B253120A1C6200C73D5),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x1]
        + Op.PUSH32[0x99D4F9EA872CE02274990B253120A1C6200C73D5]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x2819E4BE,
    )
