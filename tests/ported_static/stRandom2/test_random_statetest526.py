...
def test_random_statetest526(
    ...
    contract_0 = Address(0xC49BA7E94E99B78193D2F7CE78F92F909ECB7B84)
    sender = EOA(
    ...
    contract_0 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0xC49BA7E94E99B78193D2F7CE78F92F909ECB7B84),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=contract_0,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x3AA8C462,
    )
