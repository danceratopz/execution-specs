...
def test_static_call_ecrecover0(
    state_test: StateTestFiller,
    pre: Alloc,
) -> None:
    """Test_static_call_ecrecover0."""
    coinbase = Address(0x2ADC25665018AA1FE0E6BC666DAC8FC2697FF9BA)
    contract_0 = Address(0xF366C0FF3AFFD697D523E848002402F95C455F7A)
    sender = EOA(
    ...
    contract_0 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x1312D00,
        nonce=0,
        address=Address(0xF366C0FF3AFFD697D523E848002402F95C455F7A),  # noqa: E501
    )
