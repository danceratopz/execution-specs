...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stStaticCall/static_callcodecallcall_100_SuicideMiddleFiller.json",  # noqa: E501
    ],
)
...
def test_static_callcodecallcall_100_suicide_middle(
    ...
    pre.deploy_contract(
        code=(
            Op.SELFDESTRUCT(address=0x31D06FAD70E2A598413824A9BC68D80A5D2B194E)
            + Op.STATICCALL(
                gas=0xC350,
