...
def test_random_statetest389(
    ...
    """Test_random_statetest389."""
    coinbase = Address(0x15301CE77A3247517D551D5501A698EDF4E4318F)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x15301CE77A3247517D551D5501A698EDF4E4318F),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x0]
        + Op.TIMESTAMP
        + Op.PUSH32[0x15301CE77A3247517D551D5501A698EDF4E4318F]
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x5BF15D9B,
    )
