...
def test_static_callcallcodecall_010_oogm_after_2(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x3B8D92E4A2EDD766B3E83B87C50727D819EB2140),  # noqa: E501
    )
    # Source: lll
    # {  (MSTORE 3 1) }
    addr_4 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x528D019431EC5F130768495110597FA0FE26D8F5),  # noqa: E501
    )
    # Source: lll
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        code=Op.STATICCALL(
            gas=0x1D4E8,
            address=0x528D019431EC5F130768495110597FA0FE26D8F5,
            args_offset=0x0,
            args_size=0x40,
            ret_offset=0x0,
            ret_size=0x40,
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0x8AD2FDAD13D24F3A73995B94CFEE90B84315556D),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.POP(
            Op.DELEGATECALL(
                gas=0x61AD0,
                address=0x8AD2FDAD13D24F3A73995B94CFEE90B84315556D,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0xDC146495E265E20AB79BCDE5D9C00CB75638E19E),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0x7967B0EBEEE9BFC664F5819440728B09D9B728AC),  # noqa: E501
    )
