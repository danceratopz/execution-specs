...
Ported from:
tests/static/state_tests/stRandom/randomStatetest219Filler.json
"""
...
def test_random_statetest219(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x6253443A4104027144577F3399832055,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000ffffffffffffffffffffffffffffffffffffffff437f00000000000000000000"  # noqa: E501
            ...
            "0000000000000000000000000000c3506f6253443a4104027144577f33998320"
        ),
        gas_limit=100000,
        value=73663722,
    )
    ...
    post = {
        contract: Account(storage={0: 0x6253443A4104027144577F3399832055}),
    }
