...
def test_random_statetest304(
    ...
    """Test_random_statetest304."""
    coinbase = Address(0x65F96EB3069B0BEDA0D07196256F89E9C5091110)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x65F96EB3069B0BEDA0D07196256F89E9C5091110),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=100000,
        value=0x293D448F,
    )
