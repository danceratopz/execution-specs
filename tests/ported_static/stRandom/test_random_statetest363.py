...
def test_random_statetest363(
    ...
    """Test_random_statetest363."""
    coinbase = Address(0x812B79077C9143A42DB0843A7B7C9E6AC44714B8)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x812B79077C9143A42DB0843A7B7C9E6AC44714B8),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PUSH32[0x812B79077C9143A42DB0843A7B7C9E6AC44714B8]
        + Op.GT(
            Op.PUSH32[0xC350],
        ...
        nonce=0,
        address=Address(0xCAF50C7EFED9C2AC1920749B5B1DA29C765DCDD7),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x4C18B65E,
    )
