...
Ported from:
tests/static/state_tests/stRandom/randomStatetest305Filler.json
"""
...
def test_random_statetest305(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x606E048240069C409313318736200B55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffff7f0000000000000000000000004f3f701464"  # noqa: E501
            "972e74606d6ea82d4d3080599a0e797f0000000000000000000000000000000000000000"  # noqa: E501
            "0000000000000000000000006f606e048240069c409313318736200b"
        ),
        gas_limit=100000,
        value=218159006,
    )
    ...
    post = {
        contract: Account(storage={0: 0x606E048240069C409313318736200B55}),
    }
