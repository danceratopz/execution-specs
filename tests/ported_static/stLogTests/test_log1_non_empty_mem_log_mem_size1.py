...
Ported from:
tests/static/state_tests/stLogTests/log1_nonEmptyMem_logMemSize1Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stLogTests/log1_nonEmptyMem_logMemSize1Filler.json",  # noqa: E501
    ],
)
...
def test_log1_non_empty_mem_log_mem_size1(
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0x3E8,
                    address=0xAA71C9D8F626B8430A90ADE1BC39F086C51A2E13,
                    value=0x17,
                    args_offset=0x0,
                    args_size=0x0,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address("0xaa71c9d8f626b8430a90ade1bc39f086c51a2e13"),  # noqa: E501
    )
