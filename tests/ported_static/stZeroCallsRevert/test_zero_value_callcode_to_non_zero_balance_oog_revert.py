...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stZeroCallsRevert/ZeroValue_CALLCODE_ToNonZeroBalance_OOGRevertFiller.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Byzantium")
@pytest.mark.pre_alloc_mutable
def test_zero_value_callcode_to_non_zero_balance_oog_revert(
