...
Ported from:
tests/static/state_tests/stRandom/randomStatetest292Filler.json
"""
...
def test_random_statetest292(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x6f333ed29ba1f098ba2b1f681f8e6131c7f3d2c2"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000004f3f701464972e74606d6ea82d4d3080599a0e79417f00000000000000000000"  # noqa: E501
            ...
            "000000000000000000000000000000013063a09c825a338e"
        ),
        gas_limit=100000,
        value=828199880,
    )
