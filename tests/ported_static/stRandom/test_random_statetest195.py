...
Ported from:
tests/static/state_tests/stRandom/randomStatetest195Filler.json
"""
...
def test_random_statetest195(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000000000000000c350417fffffffff"  # noqa: E501
            ...
            "0000ffffffffffffffffffffffffffffffffffffffff097f000000000000000000000001"  # noqa: E501
