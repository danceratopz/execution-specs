...
def test_random_statetest535(
    ...
    """Test_random_statetest535."""
    coinbase = Address(0x46A7A4229102F13CFA6BAF18D280102BD406DC37)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x46A7A4229102F13CFA6BAF18D280102BD406DC37),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        * 2
        + Op.PUSH32[0x1] * 2
        + Op.PUSH32[0x46A7A4229102F13CFA6BAF18D280102BD406DC37]
        + Op.SSTORE(
            key=Op.PUSH32[0x0],
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x4CD4DC30,
    )
