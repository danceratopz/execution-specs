...
Ported from:
tests/static/state_tests/stPreCompiledContracts2/CALLCODEEcrecover0Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stPreCompiledContracts2/CALLCODEEcrecover0Filler.json",  # noqa: E501
    ],
)
