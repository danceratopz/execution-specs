...
Ported from:
tests/static/state_tests/stStaticCall/static_CallIdentity_4_gas17Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stStaticCall/static_CallIdentity_4_gas17Filler.json",  # noqa: E501
    ],
)
