...
def test_random_statetest267(
    ...
    contract_0 = Address(0x5B014F162E9BAE5D96AEE6703B387B062D019190)
    sender = EOA(
    ...
    contract_0 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x5B014F162E9BAE5D96AEE6703B387B062D019190),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=contract_0,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0xF5106AE,
    )
