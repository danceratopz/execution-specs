...
def test_random_statetest470(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x396527ef051c114a21d96eafe1f9316aa34def16"),  # noqa: E501
    )
    # Source: raw bytecode
    pre.deploy_contract(
        code=(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000001357f000000000000000000000000"  # noqa: E501
