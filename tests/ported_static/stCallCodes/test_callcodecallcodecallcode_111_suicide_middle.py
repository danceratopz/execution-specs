...
def test_callcodecallcodecallcode_111_suicide_middle(
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x2B5D5E95A33810C3FDAAC843333DC68849E8DB03),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0x249F0,
                address=0xC91DE7EC77AC6438D8EEEABB5F1B6506234E67C2,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0x87504EF48D6972CE4202250C57D1EDF508D80DF2),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0x186A0,
                address=0x869FBC7C4429553AC1A12B15E5F901A94C1F6B57,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0xC91DE7EC77AC6438D8EEEABB5F1B6506234E67C2),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.SELFDESTRUCT(
            address=0x87504EF48D6972CE4202250C57D1EDF508D80DF2
        )
        + Op.SSTORE(
            key=0x2,
            value=Op.CALLCODE(
                gas=0xC350,
                address=0x2B5D5E95A33810C3FDAAC843333DC68849E8DB03,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x869FBC7C4429553AC1A12B15E5F901A94C1F6B57),  # noqa: E501
    )
