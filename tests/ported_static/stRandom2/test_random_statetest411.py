...
def test_random_statetest411(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x44A17892738B6895619D7A93507D649D,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000000000006f44a17892738b6895619d7a93507d649d"  # noqa: E501
        ),
        gas_limit=100000,
        value=2119897718,
    )
    ...
    post = {
        contract: Account(storage={0: 0x44A17892738B6895619D7A93507D649D}),
    }
