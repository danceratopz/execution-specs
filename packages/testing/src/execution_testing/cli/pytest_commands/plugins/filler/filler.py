...
empty block: its expectations depend on absolute block positions, its
pre-state changes what any block (including an empty one) executes, or
it pins a fee value no parent value decays to across an empty block.
