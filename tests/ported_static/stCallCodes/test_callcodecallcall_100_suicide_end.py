"""
CALLCODE -> CALL -> (CALL-> code) (suicide).

Ported from:
state_tests/stCallCodes/callcodecallcall_100_SuicideEndFiller.json
...
def test_callcodecallcall_100_suicide_end(
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x8324693183FD209519CBAA2EB9E1DD70ED59979C),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            key=0x0,
            value=Op.CALLCODE(
                address=0x6C305726657A0BCED789B44A3074A0BBC27EED60,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        nonce=0,
        address=Address(0x4774FEFE1333CCB9E8FAC07D1F5397BEE4B27B95),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            key=0x1,
            value=Op.CALL(
                address=0x38CD5F86ADF26D7B8DD7EB490D2E0932D096285C,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x6C305726657A0BCED789B44A3074A0BBC27EED60),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            key=0x2,
            value=Op.CALL(
                address=0x8324693183FD209519CBAA2EB9E1DD70ED59979C,
                value=0x0,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
        ...
        + Op.SELFDESTRUCT(address=0x6C305726657A0BCED789B44A3074A0BBC27EED60)
        + Op.STOP,
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x38CD5F86ADF26D7B8DD7EB490D2E0932D096285C),  # noqa: E501
    )
