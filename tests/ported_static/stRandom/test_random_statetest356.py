...
Ported from:
tests/static/state_tests/stRandom/randomStatetest356Filler.json
"""
...
def test_random_statetest356(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000004f3f701464972e74606d6ea82d4d3080599a0e79827f00000000000000000000"  # noqa: E501
            ...
            "fffffffffffffffffffffffffffffffe04"
        ),
        gas_limit=100000,
        value=1329095939,
    )
