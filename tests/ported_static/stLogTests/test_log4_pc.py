...
Ported from:
tests/static/state_tests/stLogTests/log4_PCFiller.json
"""
...
def test_log4_pc(
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0x3E8,
                    address=0x84861F45AE3E1AA4792A50F336696EFA9902C95B,
                    value=0x17,
                    args_offset=0x0,
                    args_size=0x0,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address("0x84861f45ae3e1aa4792a50f336696efa9902c95b"),  # noqa: E501
    )
