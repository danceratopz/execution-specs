...
@pytest.mark.ported_from(
    [
        "state_tests/stStaticCall/static_callcallcodecallcode_011_OOGMAfter_1Filler.json"  # noqa: E501
    ],
)
...
def test_static_callcallcodecallcode_011_oogm_after_1(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x96FBCE10FF89CFF4B33C2743D9E27997F132C089),  # noqa: E501
    )
    # Source: lll
    # {  (MSTORE 3 1) }
    addr_4 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0xE5592FCF765AB155A49FBF29E99515168CD311C6),  # noqa: E501
    )
    # Source: lll
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.POP(
            Op.DELEGATECALL(
                gas=0x4E34,
                address=0xE5592FCF765AB155A49FBF29E99515168CD311C6,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
