...
def test_random_statetest532(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x78297BA08BA478507F413B3597109C55,
            )
        ),
        nonce=0,
        address=Address("0x5d6f57a08139951a1b3a0fb5a68138f569e70eba"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffffffffffe54447f000000000000000000"  # noqa: E501
            "000000000000000000000000000000000000000000c3507fffffffffffffffffffffffff"  # noqa: E501
            "ffffffffffffffffffffffffffffffffffffffff6f78297ba08ba478507f413b3597109c"  # noqa: E501
        ),
        gas_limit=100000,
        value=1139122760,
    )
    ...
    post = {
        contract: Account(storage={0: 0x78297BA08BA478507F413B3597109C55}),
    }
