...
def test_random_statetest281(
    ...
    """Test_random_statetest281."""
    coinbase = Address(0x6784B032CCAB9C6F0C45CA60D5F255BB9167B3EB)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x6784B032CCAB9C6F0C45CA60D5F255BB9167B3EB),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PUSH32[0x6784B032CCAB9C6F0C45CA60D5F255BB9167B3EB] * 2
        + Op.GASLIMIT
        + Op.PUSH32[0xC350]
        + Op.COINBASE
        + Op.PUSH32[0x1]
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x662E647C,
    )
