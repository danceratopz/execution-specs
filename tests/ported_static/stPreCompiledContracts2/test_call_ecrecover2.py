...
Ported from:
tests/static/state_tests/stPreCompiledContracts2/CallEcrecover2Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stPreCompiledContracts2/CallEcrecover2Filler.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Byzantium")
@pytest.mark.pre_alloc_mutable
def test_call_ecrecover2(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                key=0x0,
                value=Op.MOD(Op.MLOAD(offset=0x61), Op.EXP(0x2, 0xA0)),
            )
        ...
        balance=0x1312D00,
        nonce=0,
        address=Address("0x42aa64fdfc0af7140da38474659ae0ab48aba824"),  # noqa: E501
    )
