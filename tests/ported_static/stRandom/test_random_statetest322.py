...
Ported from:
tests/static/state_tests/stRandom/randomStatetest322Filler.json
"""
...
def test_random_statetest322(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x1206060508840294304101A3128F3455,
            )
        ),
        nonce=0,
        address=Address("0x35ae931707f4cd4ce0135870553491750a0a9d52"),  # noqa: E501
    )
    # Source: raw bytecode
    pre.deploy_contract(
        code=(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000000000000000000000000000000000427f00000000000000000000000000000000"  # noqa: E501
            "0000000000000000000000000000c3506f1206060508840294304101a3128f34"
        ),
        gas_limit=100000,
        value=824326372,
    )
    ...
    post = {
        contract: Account(storage={0: 0x1206060508840294304101A3128F3455}),
    }
