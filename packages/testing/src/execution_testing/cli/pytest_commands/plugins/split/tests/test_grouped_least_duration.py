...
class TestGroupedLeastDuration:
    """Tests for :func:`grouped_least_duration`."""
    ...
    def test_shared_key_stays_on_one_runner(self) -> None:
        ...
        groups = grouped_least_duration(2, keyed, durations)
        for g in groups:
            if a1 in g.selected:
    ...
    def test_intra_group_order_preserved(self) -> None:
        ...
        groups = grouped_least_duration(1, keyed, durations)
    ...
    def test_empty_runners(self) -> None:
        ...
        groups = grouped_least_duration(5, keyed, durations)
