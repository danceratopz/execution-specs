...
def test_random_statetest502(
    ...
    contract_0 = Address(0x002D3AA970004AC871ED6A4C9A8A26AA8C9A71A0)
    sender = EOA(
    ...
    contract_0 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x002D3AA970004AC871ED6A4C9A8A26AA8C9A71A0),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=contract_0,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x14960C58,
    )
