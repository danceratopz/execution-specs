...
Ported from:
tests/static/state_tests/stRandom/randomStatetest276Filler.json
"""
...
def test_random_statetest276(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x4382349F7B370589141A31F39741A4F2,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffff6f4382349f7b370589141a31f39741a4f2"
        ),
        gas_limit=100000,
        value=1026778874,
    )
    ...
    post = {
        contract: Account(storage={0: 0x4382349F7B370589141A31F39741A4F2}),
    }
