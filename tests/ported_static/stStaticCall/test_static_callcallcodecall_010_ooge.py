"""
Test_static_callcallcodecall_010_ooge.

Ported from:
state_tests/stStaticCall/static_callcallcodecall_010_OOGEFiller.json
"""
...
def test_static_callcallcodecall_010_ooge(
    ...
    # Source: lll
    # {   (DELEGATECALL 300000 (CALLDATALOAD 0) 0 64 0 64 ) (MSTORE 1 1) }
    ...
    addr_4 = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x2A81BE7D94D05B7E93051501430CF63A0D4512AE),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        nonce=0,
        address=Address(0x44E88D12877E2B53556565D02B1913B157BF431A),  # noqa: E501
    )
    # Source: lll
    # {  (STATICCALL 120020 <contract:0x1000000000000000000000000000000000000003> 0 64 0 64 ) (SSTORE 1 1) }  # noqa: E501
    addr_3 = pre.deploy_contract(  # noqa: F841
        code=Op.POP(
            Op.STATICCALL(
                gas=0x1D4D4,
                address=0x2A81BE7D94D05B7E93051501430CF63A0D4512AE,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
    ...
    # Source: lll
    # {  (STATICCALL 120020 <contract:0x1000000000000000000000000000000000000003> 0 64 0 64 ) (def 'i 0x80) (for {} (< @i 50000) [i](+ @i 1) (EXTCODESIZE 1)) }  # noqa: E501
