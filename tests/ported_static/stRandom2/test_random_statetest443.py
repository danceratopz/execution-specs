...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest443Filler.json
"""
...
def test_random_statetest443(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x692a3c1272ca7ff11550af64d7c6cafffbe467f8"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000001155933704"
        ),
        gas_limit=100000,
        value=1499936335,
    )
