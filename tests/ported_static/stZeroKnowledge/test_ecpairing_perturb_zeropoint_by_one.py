...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stZeroKnowledge/ecpairing_perturb_zeropoint_by_oneFiller.json",  # noqa: E501
    ],
)
...
def test_ecpairing_perturb_zeropoint_by_one(
    ...
    pre[coinbase] = Account(balance=0x52A0A9, nonce=0)
    ...
    pre[sender] = Account(balance=0xDE0B6B3A7115F57, nonce=21)
