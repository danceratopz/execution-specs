...
Ported from:
tests/static/state_tests/stRandom/randomStatetest15Filler.json
"""
...
def test_random_statetest15(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x436AF043189B6197733280A2F1F03855,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000000000000000016f436af043189b6197733280a2f1f038"  # noqa: E501
        ),
        gas_limit=100000,
        value=1501832876,
    )
    ...
    post = {
        contract: Account(storage={0: 0x436AF043189B6197733280A2F1F03855}),
    }
