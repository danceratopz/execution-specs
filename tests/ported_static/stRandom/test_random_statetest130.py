...
def test_random_statetest130(
    ...
    """Test_random_statetest130."""
    coinbase = Address(0x38A6E46458EDD982C169B0AF995A3091DFC3752D)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x38A6E46458EDD982C169B0AF995A3091DFC3752D),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        * 2
        ...
        + Op.PUSH32[0x38A6E46458EDD982C169B0AF995A3091DFC3752D] * 2
        + Op.PUSH32[
        ...
        nonce=0,
        address=Address(0x778A9E494C0C5BC6A3648B651752ADCDE32AF9FC),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x720306C0,
    )
