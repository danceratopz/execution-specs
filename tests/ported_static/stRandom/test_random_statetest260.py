"""
Test_random_statetest260.

Ported from:
state_tests/stRandom/randomStatetest260Filler.json
"""
...
def test_random_statetest260(
    ...
    """Test_random_statetest260."""
    coinbase = Address(0xFA610D4577EE5AB4158F34E14F49DA3994F8242A)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xFA610D4577EE5AB4158F34E14F49DA3994F8242A),  # noqa: E501
    )
