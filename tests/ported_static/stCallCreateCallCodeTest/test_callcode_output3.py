...
Ported from:
tests/static/state_tests/stCallCreateCallCodeTest/callcodeOutput3Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCreateCallCodeTest/callcodeOutput3Filler.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Byzantium")
@pytest.mark.pre_alloc_mutable
def test_callcode_output3(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0xadfa10b17cf59bbec369dcaaa1413070463820c0"),  # noqa: E501
    )
    # Source: raw bytecode
    pre.deploy_contract(
