...
Ported from:
tests/static/state_tests/stCreate2/create2collisionSelfdestructedOOGFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCreate2/create2collisionSelfdestructedOOGFiller.json",  # noqa: E501
    ],
)
