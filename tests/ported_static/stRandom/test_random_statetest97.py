...
def test_random_statetest97(
    ...
    """Test_random_statetest97."""
    coinbase = Address(0xE60C888051EE09DFA9C34ADEF93AD4129DB6A7F2)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xE60C888051EE09DFA9C34ADEF93AD4129DB6A7F2),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.PUSH32[0xE60C888051EE09DFA9C34ADEF93AD4129DB6A7F2]
        + Op.PC
        + Op.PUSH32[0x1]
        + Op.SWAP6
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=100000,
        value=0x14008CB2,
    )
