...
def test_random_statetest134(
    ...
    """Test_random_statetest134."""
    coinbase = Address(0xF12EAAE44AA42E84AA1F28F40397CD1F34E64E7B)
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xF12EAAE44AA42E84AA1F28F40397CD1F34E64E7B),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xF12EAAE44AA42E84AA1F28F40397CD1F34E64E7B]
        + Op.SSTORE(
            key=Op.PUSH32[0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF],
            value=Op.PUSH32[0x0],
        )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        gas_limit=100000,
        value=0x3E3E955,
    )
