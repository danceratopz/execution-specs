...
Ported from:
tests/static/state_tests/stRandom/randomStatetest378Filler.json
"""
...
def test_random_statetest378(
    ...
    tx = Transaction(
        ...
        to=contract,
        data=bytes.fromhex(
            "7f000000000000000000000000ffffffffffffffffffffffffffffffffffffffff547f00"  # noqa: E501
            ...
            "000000000000000000000000000000000000000000005a7f000000000000000000000000"  # noqa: E501
            "00000000000000000000000000000000000000016f855b445834721a5706f2891711f002"  # noqa: E501
        ),
