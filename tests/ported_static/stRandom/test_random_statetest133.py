...
Ported from:
tests/static/state_tests/stRandom/randomStatetest133Filler.json
"""
...
def test_random_statetest133(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "000000000000000000000000000000000000000000000000000001357f00000000000000"  # noqa: E501
            "000000000000000000000000000000000000000000000000017f00000000000000000000"  # noqa: E501
            "000000000000000000000000000000000000000000017f0000000000000000000000004f"  # noqa: E501
            "3f701464972e74606d6ea82d4d3080599a0e797f00000000000000000000000000000000"  # noqa: E501
            "0000000000000000000000000000000035830b503516a46d0b03"
        ),
        nonce=0,
        address=Address("0x329bc91a29577639030b3d2025ecfa2ab0fc3ba8"),  # noqa: E501
    )
    # Source: raw bytecode
    pre.deploy_contract(
        code=(
