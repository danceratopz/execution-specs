...
def test_random_statetest338(
    ...
    """Test_random_statetest338."""
    coinbase = Address(0x261123798CD84FAE7A9B916CF209FA1E41D968D7)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x261123798CD84FAE7A9B916CF209FA1E41D968D7),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x261123798CD84FAE7A9B916CF209FA1E41D968D7] * 2
        + Op.PUSH32[
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
