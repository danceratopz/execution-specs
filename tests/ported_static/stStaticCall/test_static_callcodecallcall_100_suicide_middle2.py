"""
Test_static_callcodecallcall_100_suicide_middle2.

Ported from:
state_tests/stStaticCall/static_callcodecallcall_100_SuicideMiddle2Filler.json
"""
...
def test_static_callcodecallcall_100_suicide_middle2(
    ...
    addr_3 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x1AEFAE1A2095329CB2C9C771D75346CC3DA08B36),  # noqa: E501
    )
    # Source: lll
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.CALLCODE(
                gas=0x249F0,
                address=0x72549084F27745B1ECDB4A0D2A477979187C8E11,
                value=Op.CALLVALUE,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.STATICCALL(
            gas=0x186A0,
            address=0x5C0A741059530DE0C9072CADCA2F6CE4B47BE2CB,
            args_offset=0x0,
            args_size=0x40,
            ret_offset=0x0,
            ret_size=0x40,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x72549084F27745B1ECDB4A0D2A477979187C8E11),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        code=Op.SELFDESTRUCT(address=0x7912B9147D3319B09CBAB380F10819D0BF0066D)
        + Op.STATICCALL(
            gas=0xC350,
            address=0x1AEFAE1A2095329CB2C9C771D75346CC3DA08B36,
            args_offset=0x0,
            args_size=0x40,
            ret_offset=0x0,
            ret_size=0x40,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x5C0A741059530DE0C9072CADCA2F6CE4B47BE2CB),  # noqa: E501
    )
