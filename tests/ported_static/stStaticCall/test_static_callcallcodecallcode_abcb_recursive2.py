...
def test_static_callcallcodecallcode_abcb_recursive2(
    ...
    target = pre.deploy_contract(  # noqa: F841
        code=Op.SSTORE(
            ...
            value=Op.STATICCALL(
                gas=0x17D7840,
                address=0x5A73C5336FB9911D1CC8B9BFBA586B050FCA3796,
                args_offset=0x0,
                args_size=0x40,
                ret_offset=0x0,
                ret_size=0x40,
        ...
        nonce=0,
        address=Address(0x15A13C5BF79117CDD9B062954E7CF7A82F82D596),  # noqa: E501
    )
    # Source: lll
    ...
    addr = pre.deploy_contract(  # noqa: F841
        code=Op.CALLCODE(
            gas=0xF4240,
            address=0x8B0691AC2384149C90613AA3B00E708A7A035EAA,
            value=0x0,
            args_offset=0x0,
            args_size=0x40,
            ret_offset=0x0,
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x5A73C5336FB9911D1CC8B9BFBA586B050FCA3796),  # noqa: E501
    )
    # Source: lll
    ...
    addr_2 = pre.deploy_contract(  # noqa: F841
        ...
        balance=0x2540BE400,
        nonce=0,
        address=Address(0x8B0691AC2384149C90613AA3B00E708A7A035EAA),  # noqa: E501
    )
