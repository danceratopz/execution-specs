...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest511Filler.json
"""
...
def test_random_statetest511(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x6A52027F41F267453843630A66444145,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "ffffffffffffffffffffffffffffffffffff416f6a52027f41f267453843630a66444145"  # noqa: E501
        ),
        gas_limit=100000,
        value=462006051,
    )
    ...
    post = {
        contract: Account(storage={0: 0x6A52027F41F267453843630A66444145}),
    }
