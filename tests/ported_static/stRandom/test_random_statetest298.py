...
Ported from:
tests/static/state_tests/stRandom/randomStatetest298Filler.json
"""
...
def test_random_statetest298(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x7C542006528B69FF3A7A3A0401613C55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000c3500a6f7c542006528b69ff3a7a3a0401613c"
        ),
        gas_limit=100000,
        value=2114938379,
    )
    ...
    post = {
        contract: Account(storage={0: 0x7C542006528B69FF3A7A3A0401613C55}),
    }
