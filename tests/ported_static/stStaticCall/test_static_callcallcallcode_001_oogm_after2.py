...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stStaticCall/static_callcallcallcode_001_OOGMAfter2Filler.json",  # noqa: E501
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "000000000000000000000000142cc6371ac4a38c018d3d1fda49a9327d8b0b45",
    ],
    ids=["case0", "case1"],
)
