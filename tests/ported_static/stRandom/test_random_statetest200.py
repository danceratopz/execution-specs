...
def test_random_statetest200(
    ...
    """Test_random_statetest200."""
    coinbase = Address(0x14A7D7F57F2F82AFD32373435A9A0CC73BA6744D)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x14A7D7F57F2F82AFD32373435A9A0CC73BA6744D),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x14A7D7F57F2F82AFD32373435A9A0CC73BA6744D]
        + Op.CALLVALUE
        + Op.SSTORE(key=Op.DUP1, value=0x42051AF2A24050039E9D3A678B028A0A),
        nonce=0,
        address=Address(0x16C2D1C5A69FA047F6C8F529EE8D728246515FA9),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x3F51031D,
    )
