...
def test_static_check_opcodes3(
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0x448E14558DAB04D90CCE865356CFD2E40A28E6F7),  # noqa: E501
    )
    # Source: lll
    ...
    addr_7 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.JUMPI(
            pc=0x4B,
            condition=Op.EQ(
                0x2E5DC1C94AF89D7C115126FCEBAD7A5C50F5FE35, Op.CALLER
            ),
        )
        + Op.SSTORE(key=0x1, value=0x2)
        + Op.JUMP(pc=0x51)
        ...
        + Op.JUMPI(
            pc=0x74,
            condition=Op.EQ(
                0xA131950507C8977B0DE1790C8E76A1A28DD92805, Op.ADDRESS
            ),
        )
        + Op.SSTORE(key=0x1, value=0x2)
        + Op.JUMP(pc=0x7A)
    ...
    addr_8 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.JUMPI(
            pc=0x4B,
            condition=Op.EQ(
                0x9B68A6B37AF295C7FD23AA2269DB8C875C2B86B4, Op.CALLER
            ),
        )
        + Op.SSTORE(key=0x1, value=0x2)
        + Op.JUMP(pc=0x51)
        ...
        + Op.JUMPI(
            pc=0x74,
            condition=Op.EQ(
                0x981585DCF04B40DFFCF24CC2A931F8D0893A13D6, Op.ADDRESS
            ),
        )
        + Op.SSTORE(key=0x1, value=0x2)
        + Op.JUMP(pc=0x7A)
        ...
        + Op.STOP,
        nonce=0,
        address=Address(0x981585DCF04B40DFFCF24CC2A931F8D0893A13D6),  # noqa: E501
    )
    # Source: lll
    ...
    addr_9 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.JUMPI(
            pc=0x4B,
            condition=Op.EQ(
                0xBA044A82B25080BC96678B9FA77678E014605C48, Op.CALLER
            ),
        )
        + Op.SSTORE(key=0x1, value=0x2)
        + Op.JUMP(pc=0x51)
        ...
        + Op.JUMPI(
            pc=0x74,
            condition=Op.EQ(
                0xB93CF5121157D61AB42345F5A5E9815B19CEC2CC, Op.ADDRESS
            ),
        )
        + Op.SSTORE(key=0x1, value=0x2)
        + Op.JUMP(pc=0x7A)
    ...
    addr_10 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.JUMPI(
            pc=0x4B,
            condition=Op.EQ(
                0xE541572CE4B4CCBB2B92AAB0FB852F018D51C512, Op.CALLER
            ),
        )
        + Op.SSTORE(key=0x1, value=0x2)
        + Op.JUMP(pc=0x51)
        ...
        + Op.JUMPI(
            pc=0x74,
            condition=Op.EQ(
                0x6D797B6A2C5F22885C4068990F19AE845D698A79, Op.ADDRESS
            ),
        )
        + Op.SSTORE(key=0x1, value=0x2)
        + Op.JUMP(pc=0x7A)
    ...
    addr_11 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.JUMPI(
            pc=0x4B,
            condition=Op.EQ(
                0x8113F9FC0868700534ECBECF1120A812CB1AF0AC, Op.CALLER
            ),
        )
        + Op.SSTORE(key=0x1, value=0x2)
        + Op.JUMP(pc=0x51)
        ...
        + Op.JUMPI(
            pc=0x74,
            condition=Op.EQ(
                0x4AF0C90F8F7B7834E7E7BD57DDA960412F9650F9, Op.ADDRESS
            ),
        )
        + Op.SSTORE(key=0x1, value=0x2)
        + Op.JUMP(pc=0x7A)
