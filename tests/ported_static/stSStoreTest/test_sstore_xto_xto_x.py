...
Ported from:
tests/static/state_tests/stSStoreTest/sstore_XtoXtoXFiller.json
"""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "6000601580603860003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f1500000fe600160005560016000556001600055600160015500",  # noqa: E501
            1000000,
            {
                Address("0xb000000000000000000000000000000000000000"): Account(
                    storage={1: 1}
                ),
                Address("0xba3394a0586b8419b4cf72c7d0f7e75a55a703f8"): Account(
                    storage={0: 1, 1: 1}
                ),
                Address("0xc000000000000000000000000000000000000000"): Account(
                    storage={1: 1}
        ...
        (
            "6000601580603d60003960006000f5506000600060006000600073dea0000000000000000000000000000000000000620927c0f15060206000fd0000fe600160005560016000556001600055600160015500",  # noqa: E501
            1000000,
            {
                Address("0xb000000000000000000000000000000000000000"): Account(
                    storage={1: 1}
