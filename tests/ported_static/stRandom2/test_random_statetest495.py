...
Ported from:
tests/static/state_tests/stRandom2/randomStatetest495Filler.json
"""
...
def test_random_statetest495(
    ...
    contract = pre.deploy_contract(
        code=bytes.fromhex(
            ...
            "0100000000000000000000000000000000000000006f427fffffffffffffffffffffffff"  # noqa: E501
            "fffffffffffffffffffffffffffffffffffffffe7e6410f26f519c538ea2070a6c600051"  # noqa: E501
            "55"
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "000000004f3f701464972e74606d6ea82d4d3080599a0e797f0000000000000000000000"  # noqa: E501
            "0100000000000000000000000000000000000000006f427fffffffffffffffffffffffff"  # noqa: E501
            "fffffffffffffffffffffffffffffffffffffffe7e6410f26f519c538ea2070a6c"  # noqa: E501
        ),
        gas_limit=100000,
        value=211829998,
    )
