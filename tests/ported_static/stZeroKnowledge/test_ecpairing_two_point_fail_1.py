...
Ported from:
tests/static/state_tests/stZeroKnowledge/ecpairing_two_point_fail_1Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stZeroKnowledge/ecpairing_two_point_fail_1Filler.json",  # noqa: E501
    ],
)
...
def test_ecpairing_two_point_fail_1(
    ...
    pre[coinbase] = Account(balance=0x19B0EB, nonce=0)
    ...
    pre[sender] = Account(balance=0xDE0B6B3A74A4F15, nonce=9)
