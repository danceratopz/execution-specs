...
def test_random_statetest424(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x18116552626186825096665471140A55,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000436f18116552626186825096665471140a"  # noqa: E501
        ),
        gas_limit=100000,
        value=1271738191,
    )
    ...
    post = {
        contract: Account(storage={0: 0x18116552626186825096665471140A55}),
    }
