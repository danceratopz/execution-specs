...
Ported from:
tests/static/state_tests/stLogTests/log3_logMemsizeTooHighFiller.json
"""
...
def test_log3_log_memsize_too_high(
    ...
    contract = pre.deploy_contract(
        code=(
            Op.SSTORE(
                ...
                value=Op.CALL(
                    gas=0x3E8,
                    address=0x9C9665291C53FC348FC97C4ACA92EA13459C8367,
                    value=0x17,
                    args_offset=0x0,
                    args_size=0x0,
                    ret_offset=0x0,
    ...
    pre.deploy_contract(
        ...
        balance=0xDE0B6B3A7640000,
        nonce=0,
        address=Address("0x9c9665291c53fc348fc97c4aca92ea13459c8367"),  # noqa: E501
    )
