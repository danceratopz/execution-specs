...
Ported from:
tests/static/state_tests/stCallCodes/callcallcallcode_001_OOGMBeforeFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stCallCodes/callcallcallcode_001_OOGMBeforeFiller.json",  # noqa: E501
    ],
)
