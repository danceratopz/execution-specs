...
def test_random_statetest451(
    ...
    """Test_random_statetest451."""
    coinbase = Address(0x8FFF9D9438D85CDC0D97EF333DC0FDF1B90D7249)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x8FFF9D9438D85CDC0D97EF333DC0FDF1B90D7249),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x0]
        + Op.PUSH32[0x8FFF9D9438D85CDC0D97EF333DC0FDF1B90D7249]
        + Op.PUSH32[
            0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
        ]
        + Op.PUSH32[0x1]
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x306CA21A,
    )
