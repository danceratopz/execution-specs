...
def test_random_statetest507(
    ...
    """Test_random_statetest507."""
    coinbase = Address(0x13DE3D17F830C045653D719FEF5672C688342F6C)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0x13DE3D17F830C045653D719FEF5672C688342F6C),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0x13DE3D17F830C045653D719FEF5672C688342F6C]
        + Op.SSTORE(
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
