...
def test_random_statetest81(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x616C327E0435743C515B078453A03C55,
            )
        ),
        nonce=0,
        address=Address("0x97fbf90a1b8ccaeb7fa3a74a5c8bdf3dc10aafd4"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "fffffffffffffffffffffffffffffffffffffffffe437f000000000000000000000000ff"  # noqa: E501
            "ffffffffffffffffffffffffffffffffffffff436f616c327e0435743c515b078453a03c"  # noqa: E501
        ),
        gas_limit=100000,
        value=898282209,
    )
    ...
    post = {
        contract: Account(storage={0: 0x616C327E0435743C515B078453A03C55}),
    }
