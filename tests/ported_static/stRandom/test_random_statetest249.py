...
Ported from:
tests/static/state_tests/stRandom/randomStatetest249Filler.json
"""
...
def test_random_statetest249(
    ...
    contract = pre.deploy_contract(
        ...
        nonce=0,
        address=Address("0x315a0a977eade1395b4c6a0b078c1ef3cfaf03b9"),  # noqa: E501
    )
    # Source: raw bytecode
    pre.deploy_contract(
        code=(
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000000000000012807f000000000000"  # noqa: E501
            ...
            "000000000000000000000000000000000000000039"
        ),
        gas_limit=100000,
        value=1871659531,
    )
