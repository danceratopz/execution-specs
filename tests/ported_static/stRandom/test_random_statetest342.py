...
def test_random_statetest342(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x36314297399455797B42569E8F055655,
            )
        ),
        nonce=0,
        address=Address("0x5dc5015f1706f727bad88ce5ebc5459898b0ee4f"),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "00000000000000000000000000000000000000000000000000000041147fffffffffffff"  # noqa: E501
            ...
            "ffffffffffffffffffffffffffffffffffffffff6f36314297399455797b42569e8f0556"  # noqa: E501
        ),
        gas_limit=100000,
        value=1662167236,
    )
    ...
    post = {
        contract: Account(storage={0: 0x36314297399455797B42569E8F055655}),
    }
