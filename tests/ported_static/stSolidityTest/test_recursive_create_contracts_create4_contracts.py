...
def test_recursive_create_contracts_create4_contracts(
    ...
    contract_0 = Address(0x7A3B6413E3096FA6F5BD102BDEC9C400306A2C33)
    ...
    contract_0 = pre.deploy_contract(  # noqa: F841
        ...
        + Op.JUMPDEST
        + Op.PUSH1[0x0]
        + Op.PUSH20[0x7A3B6413E3096FA6F5BD102BDEC9C400306A2C33]
        + Op.PUSH1[0x0]
        + Op.DUP2
        + Op.SWAP1
        + Op.SSTORE
        ...
        nonce=0,
        address=Address(0x7A3B6413E3096FA6F5BD102BDEC9C400306A2C33),  # noqa: E501
    )
