...
def test_random_statetest426(
    ...
    """Test_random_statetest426."""
    coinbase = Address(0xE7F2A2CBD9CEF34629FB07843059E56E3E72FF8E)
    sender = EOA(
    ...
    coinbase = pre.deploy_contract(  # noqa: F841
        ...
        balance=46,
        nonce=0,
        address=Address(0xE7F2A2CBD9CEF34629FB07843059E56E3E72FF8E),  # noqa: E501
    )
    # Source: raw
    ...
    target = pre.deploy_contract(  # noqa: F841
        ...
        + Op.PUSH32[0xC350]
        + Op.PUSH32[0xE7F2A2CBD9CEF34629FB07843059E56E3E72FF8E]
        + Op.COINBASE
        + Op.PUSH32[
        ...
        * 2
        ...
        nonce=0,
        address=Address(0xC5D2C6E130510D2CF47922CFC2E517E235268490),  # noqa: E501
    )
    ...
    tx = Transaction(
        ...
        to=target,
        data=Bytes(
            ""  # noqa: E501
        ),
        value=0x613B33CA,
    )
