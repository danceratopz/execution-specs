...
Ported from:
tests/static/state_tests/stPreCompiledContracts2/CallEcrecover80Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stPreCompiledContracts2/CallEcrecover80Filler.json",  # noqa: E501
    ],
)
@pytest.mark.valid_from("Byzantium")
@pytest.mark.pre_alloc_mutable
def test_call_ecrecover80(
    ...
    contract = pre.deploy_contract(
        ...
        balance=0x1312D00,
        nonce=0,
        address=Address("0xf5e90f13aa1637ba33175ea73221dd55443a6d5b"),  # noqa: E501
    )
