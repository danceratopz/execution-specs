...
Ported from:
tests/static/state_tests/stSystemOperationsTest/callcodeToReturn1Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "tests/static/state_tests/stSystemOperationsTest/callcodeToReturn1Filler.json",  # noqa: E501
    ],
)
