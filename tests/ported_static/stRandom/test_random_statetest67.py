...
Ported from:
tests/static/state_tests/stRandom/randomStatetest67Filler.json
"""
...
def test_random_statetest67(
    ...
    contract = pre.deploy_contract(
        code=(
            ...
            + Op.SSTORE(
                ...
                value=0x699776659A06A27607A2166D53733155,
            )
        ),
        nonce=0,
    ...
    tx = Transaction(
        ...
        data=bytes.fromhex(
            ...
            "0000000000000000000000016f699776659a06a27607a2166d537331"
        ),
        gas_limit=100000,
        value=2113087573,
    )
    ...
    post = {
        contract: Account(storage={0: 0x699776659A06A27607A2166D53733155}),
    }
